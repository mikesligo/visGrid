		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controller2_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controller2_Connection_feature", "_UI_Controller2_type"),
				 VisGridPackage.eINSTANCE.getController2_Connection(),
				 true,
				 false,
				 true,
				 null,
