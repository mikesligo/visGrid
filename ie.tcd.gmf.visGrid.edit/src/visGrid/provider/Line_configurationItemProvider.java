		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Line_configuration_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Line_configuration_Connection_feature", "_UI_Line_configuration_type"),
				 VisGridPackage.eINSTANCE.getLine_configuration_Connection(),
				 true,
				 false,
				 true,
				 null,
