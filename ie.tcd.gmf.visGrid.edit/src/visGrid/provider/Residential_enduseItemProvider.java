		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Residential_enduse_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Residential_enduse_Connection_feature", "_UI_Residential_enduse_type"),
				 VisGridPackage.eINSTANCE.getResidential_enduse_Connection(),
				 true,
				 false,
				 true,
				 null,
