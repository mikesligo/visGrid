		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rectifier_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rectifier_Connection_feature", "_UI_Rectifier_type"),
				 VisGridPackage.eINSTANCE.getRectifier_Connection(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rectifier_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rectifier_name_feature", "_UI_Rectifier_type"),
				 VisGridPackage.eINSTANCE.getRectifier_Name(),
				 true,
				 false,
				 false,
