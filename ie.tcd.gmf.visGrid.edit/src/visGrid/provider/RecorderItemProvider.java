		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recorder_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recorder_Connection_feature", "_UI_Recorder_type"),
				 VisGridPackage.eINSTANCE.getRecorder_Connection(),
				 true,
				 false,
				 true,
				 null,
