		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Evcharger_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Evcharger_Connection_feature", "_UI_Evcharger_type"),
				 VisGridPackage.eINSTANCE.getEvcharger_Connection(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Evcharger_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Evcharger_name_feature", "_UI_Evcharger_type"),
				 VisGridPackage.eINSTANCE.getEvcharger_Name(),
				 true,
				 false,
				 false,
