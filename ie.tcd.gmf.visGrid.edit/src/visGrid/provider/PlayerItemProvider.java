...
/**
 * This is the item provider adapter for a {@link visGrid.Player} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_Connection_feature", "_UI_Player_type"),
				 VisGridPackage.eINSTANCE.getPlayer_Connection(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_property_feature", "_UI_Player_type"),
				 VisGridPackage.eINSTANCE.getPlayer_Property(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_file_feature", "_UI_Player_type"),
				 VisGridPackage.eINSTANCE.getPlayer_File(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFiletypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_filetype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_filetype_feature", "_UI_Player_type"),
				 VisGridPackage.eINSTANCE.getPlayer_Filetype(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLoopPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_loop_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_loop_feature", "_UI_Player_type"),
				 VisGridPackage.eINSTANCE.getPlayer_Loop(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
