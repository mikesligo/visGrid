		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Overhead_line_conductor_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Overhead_line_conductor_Connection_feature", "_UI_Overhead_line_conductor_type"),
				 VisGridPackage.eINSTANCE.getOverhead_line_conductor_Connection(),
				 true,
				 false,
				 true,
				 null,
