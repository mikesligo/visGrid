		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Occupantload_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Occupantload_Connection_feature", "_UI_Occupantload_type"),
				 VisGridPackage.eINSTANCE.getOccupantload_Connection(),
				 true,
				 false,
				 true,
				 null,
