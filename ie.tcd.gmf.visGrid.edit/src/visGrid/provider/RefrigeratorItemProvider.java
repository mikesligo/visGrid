		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Refrigerator_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Refrigerator_Connection_feature", "_UI_Refrigerator_type"),
				 VisGridPackage.eINSTANCE.getRefrigerator_Connection(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Refrigerator_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Refrigerator_name_feature", "_UI_Refrigerator_type"),
				 VisGridPackage.eINSTANCE.getRefrigerator_Name(),
				 true,
				 false,
				 false,
