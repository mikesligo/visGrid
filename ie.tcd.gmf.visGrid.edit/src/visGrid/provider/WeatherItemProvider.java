		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Weather_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Weather_Connection_feature", "_UI_Weather_type"),
				 VisGridPackage.eINSTANCE.getWeather_Connection(),
				 true,
				 false,
				 true,
				 null,
