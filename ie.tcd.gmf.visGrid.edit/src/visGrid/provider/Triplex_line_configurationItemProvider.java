		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triplex_line_configuration_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triplex_line_configuration_Connection_feature", "_UI_Triplex_line_configuration_type"),
				 VisGridPackage.eINSTANCE.getTriplex_line_configuration_Connection(),
				 true,
				 false,
				 true,
				 null,
