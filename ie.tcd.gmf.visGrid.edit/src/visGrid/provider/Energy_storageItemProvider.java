		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Energy_storage_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Energy_storage_Connection_feature", "_UI_Energy_storage_type"),
				 VisGridPackage.eINSTANCE.getEnergy_storage_Connection(),
				 true,
				 false,
				 true,
				 null,
