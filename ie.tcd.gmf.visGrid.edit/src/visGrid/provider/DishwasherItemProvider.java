		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dishwasher_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dishwasher_Connection_feature", "_UI_Dishwasher_type"),
				 VisGridPackage.eINSTANCE.getDishwasher_Connection(),
				 true,
				 false,
				 true,
				 null,
