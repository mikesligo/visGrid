		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triplex_node_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triplex_node_Connection_feature", "_UI_Triplex_node_type"),
				 VisGridPackage.eINSTANCE.getTriplex_node_Connection(),
				 true,
				 false,
				 true,
				 null,
