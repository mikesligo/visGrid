		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Motor_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Motor_Connection_feature", "_UI_Motor_type"),
				 VisGridPackage.eINSTANCE.getMotor_Connection(),
				 true,
				 false,
				 true,
				 null,
