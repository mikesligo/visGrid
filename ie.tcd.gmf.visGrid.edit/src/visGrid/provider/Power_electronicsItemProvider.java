		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Power_electronics_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Power_electronics_Connection_feature", "_UI_Power_electronics_type"),
				 VisGridPackage.eINSTANCE.getPower_electronics_Connection(),
				 true,
				 false,
				 true,
				 null,
