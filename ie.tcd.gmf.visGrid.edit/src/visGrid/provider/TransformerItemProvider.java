		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformer_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformer_Connection_feature", "_UI_Transformer_type"),
				 VisGridPackage.eINSTANCE.getTransformer_Connection(),
				 true,
				 false,
				 true,
				 null,
