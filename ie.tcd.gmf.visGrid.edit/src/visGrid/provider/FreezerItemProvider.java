		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Freezer_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Freezer_Connection_feature", "_UI_Freezer_type"),
				 VisGridPackage.eINSTANCE.getFreezer_Connection(),
				 true,
				 false,
				 true,
				 null,
