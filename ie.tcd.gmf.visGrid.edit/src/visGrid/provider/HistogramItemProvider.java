		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Histogram_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Histogram_Connection_feature", "_UI_Histogram_type"),
				 VisGridPackage.eINSTANCE.getHistogram_Connection(),
				 true,
				 false,
				 true,
				 null,
