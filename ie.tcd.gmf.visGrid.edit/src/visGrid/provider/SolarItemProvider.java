		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Solar_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Solar_Connection_feature", "_UI_Solar_type"),
				 VisGridPackage.eINSTANCE.getSolar_Connection(),
				 true,
				 false,
				 true,
				 null,
