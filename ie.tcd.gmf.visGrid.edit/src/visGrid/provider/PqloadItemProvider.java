		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pqload_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pqload_Connection_feature", "_UI_Pqload_type"),
				 VisGridPackage.eINSTANCE.getPqload_Connection(),
				 true,
				 false,
				 true,
				 null,
