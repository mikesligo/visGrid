		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Microwave_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Microwave_Connection_feature", "_UI_Microwave_type"),
				 VisGridPackage.eINSTANCE.getMicrowave_Connection(),
				 true,
				 false,
				 true,
				 null,
