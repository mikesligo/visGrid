		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Series_reactor_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Series_reactor_Connection_feature", "_UI_Series_reactor_type"),
				 VisGridPackage.eINSTANCE.getSeries_reactor_Connection(),
				 true,
				 false,
				 true,
				 null,
