		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Auction_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Auction_Connection_feature", "_UI_Auction_type"),
				 VisGridPackage.eINSTANCE.getAuction_Connection(),
				 true,
				 false,
				 true,
				 null,
