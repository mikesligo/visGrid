		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Battery_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Battery_Connection_feature", "_UI_Battery_type"),
				 VisGridPackage.eINSTANCE.getBattery_Connection(),
				 true,
				 false,
				 true,
				 null,
