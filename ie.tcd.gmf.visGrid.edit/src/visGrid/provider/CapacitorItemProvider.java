		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Capacitor_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Capacitor_Connection_feature", "_UI_Capacitor_type"),
				 VisGridPackage.eINSTANCE.getCapacitor_Connection(),
				 true,
				 false,
				 true,
				 null,
