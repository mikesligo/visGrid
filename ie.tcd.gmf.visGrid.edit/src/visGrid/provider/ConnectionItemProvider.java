...
/**
 * This is the item provider adapter for a {@link visGrid.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_connections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_connections_feature", "_UI_Connection_type"),
				 VisGridPackage.eINSTANCE.getConnection_Connections(),
				 true,
				 false,
				 true,
				 null,
