		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Generator_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Generator_Connection_feature", "_UI_Generator_type"),
				 VisGridPackage.eINSTANCE.getGenerator_Connection(),
				 true,
				 false,
				 true,
				 null,
