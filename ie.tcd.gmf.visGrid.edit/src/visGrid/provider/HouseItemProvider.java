		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_House_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_House_Connection_feature", "_UI_House_type"),
				 VisGridPackage.eINSTANCE.getHouse_Connection(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VisGridPackage.eINSTANCE.getHouse_Name(),
				 true,
				 false,
				 false,
