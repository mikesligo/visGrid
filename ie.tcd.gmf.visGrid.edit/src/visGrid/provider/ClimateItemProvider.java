		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Climate_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Climate_Connection_feature", "_UI_Climate_type"),
				 VisGridPackage.eINSTANCE.getClimate_Connection(),
				 true,
				 false,
				 true,
				 null,
