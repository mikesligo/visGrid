		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Csv_reader_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Csv_reader_Connection_feature", "_UI_Csv_reader_type"),
				 VisGridPackage.eINSTANCE.getCsv_reader_Connection(),
				 true,
				 false,
				 true,
				 null,
