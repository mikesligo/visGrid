		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fuse_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fuse_Connection_feature", "_UI_Fuse_type"),
				 VisGridPackage.eINSTANCE.getFuse_Connection(),
				 true,
				 false,
				 true,
				 null,
