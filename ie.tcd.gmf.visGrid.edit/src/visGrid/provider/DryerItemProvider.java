		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dryer_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dryer_Connection_feature", "_UI_Dryer_type"),
				 VisGridPackage.eINSTANCE.getDryer_Connection(),
				 true,
				 false,
				 true,
				 null,
