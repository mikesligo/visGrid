		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Substation_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Substation_Connection_feature", "_UI_Substation_type"),
				 VisGridPackage.eINSTANCE.getSubstation_Connection(),
				 true,
				 false,
				 true,
				 null,
