		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clotheswasher_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clotheswasher_Connection_feature", "_UI_Clotheswasher_type"),
				 VisGridPackage.eINSTANCE.getClotheswasher_Connection(),
				 true,
				 false,
				 true,
				 null,
