		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controller_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controller_Connection_feature", "_UI_Controller_type"),
				 VisGridPackage.eINSTANCE.getController_Connection(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VisGridPackage.eINSTANCE.getController_Name(),
				 true,
				 false,
				 false,
