		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Load_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Load_Connection_feature", "_UI_Load_type"),
				 VisGridPackage.eINSTANCE.getLoad_Connection(),
				 true,
				 false,
				 true,
				 null,
