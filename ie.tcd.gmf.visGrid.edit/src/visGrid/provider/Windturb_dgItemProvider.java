		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Windturb_dg_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Windturb_dg_Connection_feature", "_UI_Windturb_dg_type"),
				 VisGridPackage.eINSTANCE.getWindturb_dg_Connection(),
				 true,
				 false,
				 true,
				 null,
