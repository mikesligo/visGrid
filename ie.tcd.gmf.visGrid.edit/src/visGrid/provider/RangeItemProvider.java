		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Range_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Range_Connection_feature", "_UI_Range_type"),
				 VisGridPackage.eINSTANCE.getRange_Connection(),
				 true,
				 false,
				 true,
				 null,
