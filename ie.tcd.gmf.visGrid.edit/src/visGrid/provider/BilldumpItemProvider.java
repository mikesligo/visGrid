		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Billdump_Connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Billdump_Connection_feature", "_UI_Billdump_type"),
				 VisGridPackage.eINSTANCE.getBilldump_Connection(),
				 true,
				 false,
				 true,
				 null,
