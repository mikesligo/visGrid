 ...
 * <ul>
 *   <li>{@link visGrid.Rectifier#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Rectifier#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Rectifier extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getRectifier_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getRectifier_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Rectifier#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
