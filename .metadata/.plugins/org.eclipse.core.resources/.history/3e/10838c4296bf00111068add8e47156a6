 ...
 * <ul>
 *   <li>{@link visGrid.impl.Series_reactorImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class Series_reactorImpl extends EObjectImpl implements Series_reactor {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.SERIES_REACTOR__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.SERIES_REACTOR__CONNECTION:
