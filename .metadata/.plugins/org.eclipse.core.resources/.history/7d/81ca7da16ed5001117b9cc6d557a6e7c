...
public class Underground_line_conductorEditPart extends ShapeNodeEditPart {
	...
	public class Underground_line_conductorFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			underground_line_conductorFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(underground_line_conductorFigureSVG1,
					BorderLayout.CENTER);

			BorderLayout layoutUnderground_line_conductorFigureSVG1 = new BorderLayout();
			underground_line_conductorFigureSVG1
					.setLayoutManager(layoutUnderground_line_conductorFigureSVG1);
			...
			inner0.add(fFigureUnderground_line_conductorNameFigure);

			FlowLayout layoutFFigureUnderground_line_conductorNameFigure = new FlowLayout();
			layoutFFigureUnderground_line_conductorNameFigure
			...
			fFigureUnderground_line_conductorNameFigure
					.setLayoutManager(layoutFFigureUnderground_line_conductorNameFigure);
