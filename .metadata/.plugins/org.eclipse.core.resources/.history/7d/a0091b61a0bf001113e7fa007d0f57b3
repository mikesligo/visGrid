 ...
 * <ul>
 *   <li>{@link visGrid.Player#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Player#getName <em>Name</em>}</li>
...
public interface Player extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getPlayer_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getPlayer_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Player#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
