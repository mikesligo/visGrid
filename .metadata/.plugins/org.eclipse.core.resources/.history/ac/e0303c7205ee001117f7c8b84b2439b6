...
public class Csv_readerEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof visGrid.diagram.edit.parts.Csv_readerCity_nameEditPart) {
			((visGrid.diagram.edit.parts.Csv_readerCity_nameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCsv_readerCity_nameFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.Csv_readerState_nameEditPart) {
			((visGrid.diagram.edit.parts.Csv_readerState_nameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCsv_readerState_nameFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.Csv_readerFilenameEditPart) {
			((visGrid.diagram.edit.parts.Csv_readerFilenameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCsv_readerFilenameFigure());
			return true;
		}
		return false;
	}
	...
	public class Csv_readerFigure extends RectangleFigure {
		...
		private void createContents() {
         ...
         File tempFile = new File("visGridImages/csv_reader.svg");
		csv_readerFigureSVG1.setURI(tempFile.toURI().toString());
			...
			inner0.add(fFigureCsv_readerNameFigure);

			FlowLayout layoutFFigureCsv_readerNameFigure = new FlowLayout();
			layoutFFigureCsv_readerNameFigure.setStretchMinorAxis(false);
			layoutFFigureCsv_readerNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureCsv_readerNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureCsv_readerNameFigure.setMajorSpacing(5);
			layoutFFigureCsv_readerNameFigure.setMinorSpacing(5);
			layoutFFigureCsv_readerNameFigure.setHorizontal(true);

			fFigureCsv_readerNameFigure
					.setLayoutManager(layoutFFigureCsv_readerNameFigure);

			fFigureCsv_readerCity_nameFigure = new WrappingLabel();
			fFigureCsv_readerCity_nameFigure.setText("<...>");

			inner0.add(fFigureCsv_readerCity_nameFigure);

			FlowLayout layoutFFigureCsv_readerCity_nameFigure = new FlowLayout();
			layoutFFigureCsv_readerCity_nameFigure.setStretchMinorAxis(false);
			layoutFFigureCsv_readerCity_nameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureCsv_readerCity_nameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureCsv_readerCity_nameFigure.setMajorSpacing(5);
			layoutFFigureCsv_readerCity_nameFigure.setMinorSpacing(5);
			layoutFFigureCsv_readerCity_nameFigure.setHorizontal(true);

			fFigureCsv_readerCity_nameFigure
					.setLayoutManager(layoutFFigureCsv_readerCity_nameFigure);

			fFigureCsv_readerState_nameFigure = new WrappingLabel();
			fFigureCsv_readerState_nameFigure.setText("<...>");

			inner0.add(fFigureCsv_readerState_nameFigure);

			FlowLayout layoutFFigureCsv_readerState_nameFigure = new FlowLayout();
			layoutFFigureCsv_readerState_nameFigure.setStretchMinorAxis(false);
			layoutFFigureCsv_readerState_nameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureCsv_readerState_nameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureCsv_readerState_nameFigure.setMajorSpacing(5);
			layoutFFigureCsv_readerState_nameFigure.setMinorSpacing(5);
			layoutFFigureCsv_readerState_nameFigure.setHorizontal(true);

			fFigureCsv_readerState_nameFigure
					.setLayoutManager(layoutFFigureCsv_readerState_nameFigure);

			fFigureCsv_readerFilenameFigure = new WrappingLabel();
			fFigureCsv_readerFilenameFigure.setText("<...>");

			inner0.add(fFigureCsv_readerFilenameFigure);

			FlowLayout layoutFFigureCsv_readerFilenameFigure = new FlowLayout();
			layoutFFigureCsv_readerFilenameFigure.setStretchMinorAxis(false);
			layoutFFigureCsv_readerFilenameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureCsv_readerFilenameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureCsv_readerFilenameFigure.setMajorSpacing(5);
			layoutFFigureCsv_readerFilenameFigure.setMinorSpacing(5);
			layoutFFigureCsv_readerFilenameFigure.setHorizontal(true);

			fFigureCsv_readerFilenameFigure
					.setLayoutManager(layoutFFigureCsv_readerFilenameFigure);
