 ...
 * @generated
 */
public class RegulatorEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RegulatorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.RegulatorItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new RegulatorFigure();
	}

	/**
	 * @generated
	 */
	public RegulatorFigure getPrimaryShape() {
		return (RegulatorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof visGrid.diagram.edit.parts.RegulatorNameEditPart) {
			((visGrid.diagram.edit.parts.RegulatorNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRegulatorNameFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == visGrid.diagram.providers.VisGridElementTypes.ConnectionConnections_4002) {
		...
		} else if (relationshipType == visGrid.diagram.providers.VisGridElementTypes.ConnectionParent_4001) {
			types.add(visGrid.diagram.providers.VisGridElementTypes.Triplex_line_configuration_2030);
			types.add(visGrid.diagram.providers.VisGridElementTypes.ZIPload_2055);
			types.add(visGrid.diagram.providers.VisGridElementTypes.Triplex_node_2042);
			types.add(visGrid.diagram.providers.VisGridElementTypes.Underground_line_2041);
	 ...
	 * @generated
	 */
	public class RegulatorFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureRegulatorNameFigure;

		/**
		 * @generated
		 */
		public RegulatorFigure() {
		...
		private void createContents() {
			...
			regulatorFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/regulator.svg");
			...
			fFigureRegulatorNameFigure = new WrappingLabel();
			fFigureRegulatorNameFigure.setText("<...>");

			inner0.add(fFigureRegulatorNameFigure);

			FlowLayout layoutFFigureRegulatorNameFigure = new FlowLayout();
			layoutFFigureRegulatorNameFigure.setStretchMinorAxis(false);
			layoutFFigureRegulatorNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureRegulatorNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureRegulatorNameFigure.setMajorSpacing(5);
			layoutFFigureRegulatorNameFigure.setMinorSpacing(5);
			layoutFFigureRegulatorNameFigure.setHorizontal(true);

			fFigureRegulatorNameFigure
					.setLayoutManager(layoutFFigureRegulatorNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRegulatorNameFigure() {
			return fFigureRegulatorNameFigure;
		}
