 ...
 * <ul>
 *   <li>{@link visGrid.impl.ControllerImpl#getConnection <em>Connection</em>}</li>
...
public class ControllerImpl extends EObjectImpl implements Controller {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.CONTROLLER__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.CONTROLLER__CONNECTION:
