 ...
 * <ul>
 *   <li>{@link visGrid.Office#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Office#getName <em>Name</em>}</li>
...
public interface Office extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getOffice_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getOffice_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Office#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
