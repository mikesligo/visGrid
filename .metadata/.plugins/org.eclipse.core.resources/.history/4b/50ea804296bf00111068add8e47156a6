 ...
 * <ul>
 *   <li>{@link visGrid.Microturbine#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Microturbine#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Microturbine extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getMicroturbine_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getMicroturbine_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Microturbine#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
