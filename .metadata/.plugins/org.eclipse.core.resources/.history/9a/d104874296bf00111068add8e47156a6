 ...
 * <ul>
 *   <li>{@link visGrid.impl.CapacitorImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class CapacitorImpl extends EObjectImpl implements Capacitor {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.CAPACITOR__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.CAPACITOR__CONNECTION:
