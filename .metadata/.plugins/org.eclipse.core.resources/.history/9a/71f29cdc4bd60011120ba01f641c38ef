...
public class ZIPloadEditPart extends ShapeNodeEditPart {
	...
	public class ZIPloadFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			zIPloadFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(zIPloadFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutZIPloadFigureSVG1 = new BorderLayout();
			zIPloadFigureSVG1.setLayoutManager(layoutZIPloadFigureSVG1);
			...
			inner0.add(fFigureZIPloadNameFigure);

			FlowLayout layoutFFigureZIPloadNameFigure = new FlowLayout();
			layoutFFigureZIPloadNameFigure.setStretchMinorAxis(false);
			layoutFFigureZIPloadNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureZIPloadNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureZIPloadNameFigure.setMajorSpacing(5);
			layoutFFigureZIPloadNameFigure.setMinorSpacing(5);
			layoutFFigureZIPloadNameFigure.setHorizontal(true);

			fFigureZIPloadNameFigure
					.setLayoutManager(layoutFFigureZIPloadNameFigure);
