 ...
 * <ul>
 *   <li>{@link visGrid.impl.SwitchImpl#getConnection <em>Connection</em>}</li>
 ...
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_in <em>Power in</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_out <em>Power out</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_losses <em>Power losses</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_in_A <em>Power in A</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_in_B <em>Power in B</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_in_C <em>Power in C</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_out_A <em>Power out A</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_out_B <em>Power out B</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_out_C <em>Power out C</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_losses_A <em>Power losses A</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_losses_B <em>Power losses B</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPower_losses_C <em>Power losses C</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getFlow_direction <em>Flow direction</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getPhases <em>Phases</em>}</li>
 *   <li>{@link visGrid.impl.SwitchImpl#getNominal_voltage <em>Nominal voltage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchImpl extends EObjectImpl implements Switch {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.SWITCH__CONNECTION);
		}
		return connection;
	}
	...
	public void setStatus(String newStatus) {
		...
		status = newStatus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__STATUS, oldStatus, status));
	}
	...
	public void setFrom(String newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__FROM, oldFrom, from));
	}
	...
	public void setTo(String newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__TO, oldTo, to));
	}
	...
	public void setPower_in(String newPower_in) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_IN, oldPower_in, power_in));
	}
	...
	public void setPower_out(String newPower_out) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_OUT, oldPower_out, power_out));
	}
	...
	public void setPower_losses(String newPower_losses) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_LOSSES, oldPower_losses, power_losses));
	}
	...
	public void setPower_in_A(String newPower_in_A) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_IN_A, oldPower_in_A, power_in_A));
	}
	...
	public void setPower_in_B(String newPower_in_B) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_IN_B, oldPower_in_B, power_in_B));
	}
	...
	public void setPower_in_C(String newPower_in_C) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_IN_C, oldPower_in_C, power_in_C));
	}
	...
	public void setPower_out_A(String newPower_out_A) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_OUT_A, oldPower_out_A, power_out_A));
	}
	...
	public void setPower_out_B(String newPower_out_B) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_OUT_B, oldPower_out_B, power_out_B));
	}
	...
	public void setPower_out_C(String newPower_out_C) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_OUT_C, oldPower_out_C, power_out_C));
	}
	...
	public void setPower_losses_A(String newPower_losses_A) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_LOSSES_A, oldPower_losses_A, power_losses_A));
	}
	...
	public void setPower_losses_B(String newPower_losses_B) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_LOSSES_B, oldPower_losses_B, power_losses_B));
	}
	...
	public void setPower_losses_C(String newPower_losses_C) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__POWER_LOSSES_C, oldPower_losses_C, power_losses_C));
	}
	...
	public void setFlow_direction(String newFlow_direction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__FLOW_DIRECTION, oldFlow_direction, flow_direction));
	}
	...
	public void setPhases(String newPhases) {
		...
		phases = newPhases;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__PHASES, oldPhases, phases));
	}
	...
	public void setNominal_voltage(String newNominal_voltage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.SWITCH__NOMINAL_VOLTAGE, oldNominal_voltage, nominal_voltage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.SWITCH__CONNECTION:
