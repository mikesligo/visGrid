 ...
 * <ul>
 *   <li>{@link visGrid.Climate#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Climate#getName <em>Name</em>}</li>
...
public interface Climate extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getClimate_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getClimate_Name()
	 * @model default=""
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Climate#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
