...
public class RegulatorEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public class Regulator_configurationFigure extends SVGFigure {
		...
		public Regulator_configurationFigure() {
			...
			this.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/regulator_configuration.svg");
			createContents();
		}
