	...
	public class StubauctionFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			stubauctionFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/stubauction.svg");
			stubauctionFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(stubauctionFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutStubauctionFigureSVG1 = new BorderLayout();
			stubauctionFigureSVG1.setLayoutManager(layoutStubauctionFigureSVG1);
			...
			inner0.add(fFigureStubauctionNameFigure);

			FlowLayout layoutFFigureStubauctionNameFigure = new FlowLayout();
			layoutFFigureStubauctionNameFigure.setStretchMinorAxis(false);
			layoutFFigureStubauctionNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureStubauctionNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureStubauctionNameFigure.setMajorSpacing(5);
			layoutFFigureStubauctionNameFigure.setMinorSpacing(5);
			layoutFFigureStubauctionNameFigure.setHorizontal(true);

			fFigureStubauctionNameFigure
					.setLayoutManager(layoutFFigureStubauctionNameFigure);
