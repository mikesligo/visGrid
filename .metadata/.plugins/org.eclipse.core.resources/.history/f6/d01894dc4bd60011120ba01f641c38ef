...
public class LightsEditPart extends ShapeNodeEditPart {
	...
	public class LightsFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			lightsFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/lights.svg");
			lightsFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(lightsFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutLightsFigureSVG1 = new BorderLayout();
			lightsFigureSVG1.setLayoutManager(layoutLightsFigureSVG1);
			...
			inner0.add(fFigureLightsNameFigure);

			FlowLayout layoutFFigureLightsNameFigure = new FlowLayout();
			layoutFFigureLightsNameFigure.setStretchMinorAxis(false);
			layoutFFigureLightsNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureLightsNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureLightsNameFigure.setMajorSpacing(5);
			layoutFFigureLightsNameFigure.setMinorSpacing(5);
			layoutFFigureLightsNameFigure.setHorizontal(true);

			fFigureLightsNameFigure
					.setLayoutManager(layoutFFigureLightsNameFigure);
