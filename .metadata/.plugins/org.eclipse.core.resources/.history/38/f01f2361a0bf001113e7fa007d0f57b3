 ...
 * <ul>
 *   <li>{@link visGrid.impl.Overhead_line_conductorImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class Overhead_line_conductorImpl extends EObjectImpl implements Overhead_line_conductor {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.OVERHEAD_LINE_CONDUCTOR__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.OVERHEAD_LINE_CONDUCTOR__CONNECTION:
