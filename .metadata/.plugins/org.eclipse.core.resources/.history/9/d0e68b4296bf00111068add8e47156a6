 ...
 * <ul>
 *   <li>{@link visGrid.impl.PqloadImpl#getConnection <em>Connection</em>}</li>
...
public class PqloadImpl extends EObjectImpl implements Pqload {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.PQLOAD__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.PQLOAD__CONNECTION:
