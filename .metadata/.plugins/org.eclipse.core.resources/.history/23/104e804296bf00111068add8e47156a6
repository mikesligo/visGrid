 ...
 * <ul>
 *   <li>{@link visGrid.Inverter#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Inverter#getName <em>Name</em>}</li>
...
public interface Inverter extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getInverter_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getInverter_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Inverter#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
