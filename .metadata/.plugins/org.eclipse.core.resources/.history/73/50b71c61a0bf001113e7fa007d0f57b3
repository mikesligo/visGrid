 ...
 * <ul>
 *   <li>{@link visGrid.Triplex_line#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Triplex_line#getName <em>Name</em>}</li>
...
public interface Triplex_line extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getTriplex_line_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getTriplex_line_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Triplex_line#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
