 ...
 * <ul>
 *   <li>{@link visGrid.Battery#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Battery#getName <em>Name</em>}</li>
...
public interface Battery extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getBattery_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getBattery_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Battery#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
