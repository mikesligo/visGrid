...
public class RectifierEditPart extends ShapeNodeEditPart {
	...
	public class RectifierFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			rectifierFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/rectifier.svg");
			rectifierFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(rectifierFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutRectifierFigureSVG1 = new BorderLayout();
			rectifierFigureSVG1.setLayoutManager(layoutRectifierFigureSVG1);
			...
			inner0.add(fFigureRectifierNameFigure);

			FlowLayout layoutFFigureRectifierNameFigure = new FlowLayout();
			layoutFFigureRectifierNameFigure.setStretchMinorAxis(false);
			layoutFFigureRectifierNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureRectifierNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureRectifierNameFigure.setMajorSpacing(5);
			layoutFFigureRectifierNameFigure.setMinorSpacing(5);
			layoutFFigureRectifierNameFigure.setHorizontal(true);

			fFigureRectifierNameFigure
					.setLayoutManager(layoutFFigureRectifierNameFigure);
