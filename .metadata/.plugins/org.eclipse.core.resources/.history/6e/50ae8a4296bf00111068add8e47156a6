 ...
 * <ul>
 *   <li>{@link visGrid.impl.LoadImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class LoadImpl extends EObjectImpl implements Load {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.LOAD__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.LOAD__CONNECTION:
