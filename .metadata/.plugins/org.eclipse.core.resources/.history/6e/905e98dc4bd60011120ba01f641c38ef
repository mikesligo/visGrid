...
public class RecorderEditPart extends ShapeNodeEditPart {
	...
	public class RecorderFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			recorderFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/recorder.svg");
			recorderFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(recorderFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutRecorderFigureSVG1 = new BorderLayout();
			recorderFigureSVG1.setLayoutManager(layoutRecorderFigureSVG1);
			...
			inner0.add(fFigureRecorderNameFigure);

			FlowLayout layoutFFigureRecorderNameFigure = new FlowLayout();
			layoutFFigureRecorderNameFigure.setStretchMinorAxis(false);
			layoutFFigureRecorderNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureRecorderNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureRecorderNameFigure.setMajorSpacing(5);
			layoutFFigureRecorderNameFigure.setMinorSpacing(5);
			layoutFFigureRecorderNameFigure.setHorizontal(true);

			fFigureRecorderNameFigure
					.setLayoutManager(layoutFFigureRecorderNameFigure);
