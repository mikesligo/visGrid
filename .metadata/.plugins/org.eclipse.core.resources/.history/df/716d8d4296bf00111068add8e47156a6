 ...
 * <ul>
 *   <li>{@link visGrid.impl.Underground_line_conductorImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class Underground_line_conductorImpl extends EObjectImpl implements Underground_line_conductor {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.UNDERGROUND_LINE_CONDUCTOR__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.UNDERGROUND_LINE_CONDUCTOR__CONNECTION:
