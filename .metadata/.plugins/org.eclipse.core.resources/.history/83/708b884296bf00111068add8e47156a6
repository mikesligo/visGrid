 ...
 * <ul>
 *   <li>{@link visGrid.impl.Energy_storageImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class Energy_storageImpl extends EObjectImpl implements Energy_storage {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.ENERGY_STORAGE__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.ENERGY_STORAGE__CONNECTION:
