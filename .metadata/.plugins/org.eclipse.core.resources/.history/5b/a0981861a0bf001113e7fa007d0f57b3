 ...
 * <ul>
 *   <li>{@link visGrid.Energy_storage#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Energy_storage#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Energy_storage extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getEnergy_storage_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getEnergy_storage_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Energy_storage#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
