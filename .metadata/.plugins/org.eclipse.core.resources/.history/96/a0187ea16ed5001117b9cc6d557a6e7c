...
public class Volt_var_controlEditPart extends ShapeNodeEditPart {
	...
	public class Volt_var_controlFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			volt_var_controlFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(volt_var_controlFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutVolt_var_controlFigureSVG1 = new BorderLayout();
			volt_var_controlFigureSVG1
					.setLayoutManager(layoutVolt_var_controlFigureSVG1);
			...
			inner0.add(fFigureVolt_var_controlNameFigure);

			FlowLayout layoutFFigureVolt_var_controlNameFigure = new FlowLayout();
			layoutFFigureVolt_var_controlNameFigure.setStretchMinorAxis(false);
			layoutFFigureVolt_var_controlNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureVolt_var_controlNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureVolt_var_controlNameFigure.setMajorSpacing(5);
			layoutFFigureVolt_var_controlNameFigure.setMinorSpacing(5);
			layoutFFigureVolt_var_controlNameFigure.setHorizontal(true);

			fFigureVolt_var_controlNameFigure
					.setLayoutManager(layoutFFigureVolt_var_controlNameFigure);
