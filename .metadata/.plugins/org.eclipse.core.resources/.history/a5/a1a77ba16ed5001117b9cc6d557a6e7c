...
public class ShaperEditPart extends ShapeNodeEditPart {
	...
	public class ShaperFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			shaperFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/shaper.svg");
			shaperFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(shaperFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutShaperFigureSVG1 = new BorderLayout();
			shaperFigureSVG1.setLayoutManager(layoutShaperFigureSVG1);
			...
			inner0.add(fFigureShaperNameFigure);

			FlowLayout layoutFFigureShaperNameFigure = new FlowLayout();
			layoutFFigureShaperNameFigure.setStretchMinorAxis(false);
			layoutFFigureShaperNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureShaperNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureShaperNameFigure.setMajorSpacing(5);
			layoutFFigureShaperNameFigure.setMinorSpacing(5);
			layoutFFigureShaperNameFigure.setHorizontal(true);

			fFigureShaperNameFigure
					.setLayoutManager(layoutFFigureShaperNameFigure);
