...
public class DryerEditPart extends ShapeNodeEditPart {
	...
	public class DryerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			dryerFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/dryer.svg");
			dryerFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(dryerFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutDryerFigureSVG1 = new BorderLayout();
			dryerFigureSVG1.setLayoutManager(layoutDryerFigureSVG1);
			...
			inner0.add(fFigureDryerNameFigure);

			FlowLayout layoutFFigureDryerNameFigure = new FlowLayout();
			layoutFFigureDryerNameFigure.setStretchMinorAxis(false);
			layoutFFigureDryerNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureDryerNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureDryerNameFigure.setMajorSpacing(5);
			layoutFFigureDryerNameFigure.setMinorSpacing(5);
			layoutFFigureDryerNameFigure.setHorizontal(true);

			fFigureDryerNameFigure
					.setLayoutManager(layoutFFigureDryerNameFigure);
