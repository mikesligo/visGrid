 ...
 * <ul>
 *   <li>{@link visGrid.impl.HouseImpl#getConnection <em>Connection</em>}</li>
...
public class HouseImpl extends EObjectImpl implements House {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.HOUSE__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.HOUSE__CONNECTION:
