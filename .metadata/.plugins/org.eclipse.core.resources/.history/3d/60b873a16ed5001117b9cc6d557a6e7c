...
public class Controller2EditPart extends ShapeNodeEditPart {
	...
	public class Controller2Figure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure controller2FigureSVG1 = new SVGFigure();
			controller2FigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/controller2.svg");
			controller2FigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(controller2FigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutController2FigureSVG1 = new BorderLayout();
			controller2FigureSVG1.setLayoutManager(layoutController2FigureSVG1);
			...
			inner0.add(fFigureController2NameFigure);

			FlowLayout layoutFFigureController2NameFigure = new FlowLayout();
			layoutFFigureController2NameFigure.setStretchMinorAxis(false);
			layoutFFigureController2NameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureController2NameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureController2NameFigure.setMajorSpacing(5);
			layoutFFigureController2NameFigure.setMinorSpacing(5);
			layoutFFigureController2NameFigure.setHorizontal(true);

			fFigureController2NameFigure
					.setLayoutManager(layoutFFigureController2NameFigure);
