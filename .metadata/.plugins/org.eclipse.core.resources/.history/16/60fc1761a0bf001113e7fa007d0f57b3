 ...
 * <ul>
 *   <li>{@link visGrid.Controller#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Controller#getName <em>Name</em>}</li>
...
public interface Controller extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getController_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getController_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Controller#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
