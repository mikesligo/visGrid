 ...
 * <ul>
 *   <li>{@link visGrid.impl.MicroturbineImpl#getConnection <em>Connection</em>}</li>
...
public class MicroturbineImpl extends EObjectImpl implements Microturbine {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.MICROTURBINE__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.MICROTURBINE__CONNECTION:
