	...
	public class Series_reactorFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			series_reactorFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/series_reactor.svg");
			series_reactorFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(series_reactorFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutSeries_reactorFigureSVG1 = new BorderLayout();
			series_reactorFigureSVG1
					.setLayoutManager(layoutSeries_reactorFigureSVG1);
			...
			inner0.add(fFigureSeries_reactorNameFigure);

			FlowLayout layoutFFigureSeries_reactorNameFigure = new FlowLayout();
			layoutFFigureSeries_reactorNameFigure.setStretchMinorAxis(false);
			layoutFFigureSeries_reactorNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureSeries_reactorNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureSeries_reactorNameFigure.setMajorSpacing(5);
			layoutFFigureSeries_reactorNameFigure.setMinorSpacing(5);
			layoutFFigureSeries_reactorNameFigure.setHorizontal(true);

			fFigureSeries_reactorNameFigure
					.setLayoutManager(layoutFFigureSeries_reactorNameFigure);
