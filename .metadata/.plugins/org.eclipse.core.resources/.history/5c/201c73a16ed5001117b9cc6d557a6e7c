	...
	public class ClotheswasherFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			clotheswasherFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/clotheswasher.svg");
			clotheswasherFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(clotheswasherFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutClotheswasherFigureSVG1 = new BorderLayout();
			clotheswasherFigureSVG1
					.setLayoutManager(layoutClotheswasherFigureSVG1);
			...
			inner0.add(fFigureClotheswasherNameFigure);

			FlowLayout layoutFFigureClotheswasherNameFigure = new FlowLayout();
			layoutFFigureClotheswasherNameFigure.setStretchMinorAxis(false);
			layoutFFigureClotheswasherNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureClotheswasherNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureClotheswasherNameFigure.setMajorSpacing(5);
			layoutFFigureClotheswasherNameFigure.setMinorSpacing(5);
			layoutFFigureClotheswasherNameFigure.setHorizontal(true);

			fFigureClotheswasherNameFigure
					.setLayoutManager(layoutFFigureClotheswasherNameFigure);
