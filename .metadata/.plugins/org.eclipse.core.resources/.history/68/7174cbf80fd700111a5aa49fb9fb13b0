...
public class VisGridVisualIDRegistry {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case visGrid.diagram.edit.parts.Overhead_lineEditPart.VISUAL_ID:
			...
			if (visGrid.diagram.edit.parts.Overhead_linePower_losses_AEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.Overhead_linePower_losses_BEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case visGrid.diagram.edit.parts.NodeEditPart.VISUAL_ID:
			...
			if (visGrid.diagram.edit.parts.NodeVoltage_AEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.NodeVoltage_BEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.NodeVoltage_CEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.NodeVoltage_ABEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.NodeVoltage_BCEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.NodeVoltage_CAEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case visGrid.diagram.edit.parts.Triplex_meterEditPart.VISUAL_ID:
			...
			if (visGrid.diagram.edit.parts.Triplex_meterMeasured_reactive_powerEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.Triplex_meterMeasured_voltage_1EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.Triplex_meterMeasured_voltage_2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case visGrid.diagram.edit.parts.Triplex_lineEditPart.VISUAL_ID:
			...
			if (visGrid.diagram.edit.parts.Triplex_linePower_losses_AEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.Triplex_linePower_losses_BEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (visGrid.diagram.edit.parts.Triplex_linePower_losses_CEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
