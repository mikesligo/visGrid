...
public class Fault_checkEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public class Fault_checkFigure extends SVGFigure {
		...
		public Fault_checkFigure() {
			...
			this.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/fault_check.svg");
			createContents();
		}
		...
		private void createContents() {
			...
			this.add(fFigureFault_checkNameFigure);
