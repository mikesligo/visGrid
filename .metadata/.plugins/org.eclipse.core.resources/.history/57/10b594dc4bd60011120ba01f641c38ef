...
public class LinkEditPart extends ShapeNodeEditPart {
	...
	public class LinkFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			linkFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/link.svg");
			linkFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(linkFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutLinkFigureSVG1 = new BorderLayout();
			linkFigureSVG1.setLayoutManager(layoutLinkFigureSVG1);
			...
			inner0.add(fFigureLinkNameFigure);

			FlowLayout layoutFFigureLinkNameFigure = new FlowLayout();
			layoutFFigureLinkNameFigure.setStretchMinorAxis(false);
			layoutFFigureLinkNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureLinkNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureLinkNameFigure.setMajorSpacing(5);
			layoutFFigureLinkNameFigure.setMinorSpacing(5);
			layoutFFigureLinkNameFigure.setHorizontal(true);

			fFigureLinkNameFigure.setLayoutManager(layoutFFigureLinkNameFigure);
