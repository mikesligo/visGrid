...
public class RangeEditPart extends ShapeNodeEditPart {
	...
	public class RangeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			rangeFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/range.svg");
			rangeFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(rangeFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutRangeFigureSVG1 = new BorderLayout();
			rangeFigureSVG1.setLayoutManager(layoutRangeFigureSVG1);
			...
			inner0.add(fFigureRangeNameFigure);

			FlowLayout layoutFFigureRangeNameFigure = new FlowLayout();
			layoutFFigureRangeNameFigure.setStretchMinorAxis(false);
			layoutFFigureRangeNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureRangeNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureRangeNameFigure.setMajorSpacing(5);
			layoutFFigureRangeNameFigure.setMinorSpacing(5);
			layoutFFigureRangeNameFigure.setHorizontal(true);

			fFigureRangeNameFigure
					.setLayoutManager(layoutFFigureRangeNameFigure);
