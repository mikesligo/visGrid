...
public class LoadEditPart extends ShapeNodeEditPart {
	...
	public class LoadFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			loadFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/load.svg");
			loadFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(loadFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutLoadFigureSVG1 = new BorderLayout();
			loadFigureSVG1.setLayoutManager(layoutLoadFigureSVG1);
			...
			inner0.add(fFigureLoadNameFigure, BorderLayout.TOP);
