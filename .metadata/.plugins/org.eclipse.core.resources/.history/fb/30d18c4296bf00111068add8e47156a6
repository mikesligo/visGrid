 ...
 * <ul>
 *   <li>{@link visGrid.impl.StubauctionImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class StubauctionImpl extends EObjectImpl implements Stubauction {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.STUBAUCTION__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.STUBAUCTION__CONNECTION:
