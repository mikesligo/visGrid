 ...
 * <ul>
 *   <li>{@link visGrid.impl.WaterheaterImpl#getConnection <em>Connection</em>}</li>
...
public class WaterheaterImpl extends EObjectImpl implements Waterheater {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.WATERHEATER__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.WATERHEATER__CONNECTION:
