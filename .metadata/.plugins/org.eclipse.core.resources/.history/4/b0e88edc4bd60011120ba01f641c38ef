...
public class AuctionEditPart extends ShapeNodeEditPart {
	...
	public class AuctionFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			auctionFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(auctionFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutAuctionFigureSVG1 = new BorderLayout();
			auctionFigureSVG1.setLayoutManager(layoutAuctionFigureSVG1);
			...
			inner0.add(fFigureAuctionNameFigure);

			FlowLayout layoutFFigureAuctionNameFigure = new FlowLayout();
			layoutFFigureAuctionNameFigure.setStretchMinorAxis(false);
			layoutFFigureAuctionNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureAuctionNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureAuctionNameFigure.setMajorSpacing(5);
			layoutFFigureAuctionNameFigure.setMinorSpacing(5);
			layoutFFigureAuctionNameFigure.setHorizontal(true);

			fFigureAuctionNameFigure
					.setLayoutManager(layoutFFigureAuctionNameFigure);
