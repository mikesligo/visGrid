...
public class Residential_enduseEditPart extends ShapeNodeEditPart {
	...
	public class Residential_enduseFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			residential_enduseFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(residential_enduseFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutResidential_enduseFigureSVG1 = new BorderLayout();
			residential_enduseFigureSVG1
					.setLayoutManager(layoutResidential_enduseFigureSVG1);
			...
			inner0.add(fFigureResidential_enduseNameFigure);

			FlowLayout layoutFFigureResidential_enduseNameFigure = new FlowLayout();
			layoutFFigureResidential_enduseNameFigure
			...
			layoutFFigureResidential_enduseNameFigure.setMajorSpacing(5);
			layoutFFigureResidential_enduseNameFigure.setMinorSpacing(5);
			layoutFFigureResidential_enduseNameFigure.setHorizontal(true);

			fFigureResidential_enduseNameFigure
					.setLayoutManager(layoutFFigureResidential_enduseNameFigure);
