...
public class Overhead_line_conductorEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public class Overhead_line_conductorFigure extends SVGFigure {
		...
		public Overhead_line_conductorFigure() {
			...
			this.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/overhead_line_conductor.svg");
			createContents();
		}
