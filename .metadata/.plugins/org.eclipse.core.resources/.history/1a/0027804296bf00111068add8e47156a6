 ...
 * <ul>
 *   <li>{@link visGrid.House#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.House#getName <em>Name</em>}</li>
...
public interface House extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getHouse_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getHouse_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.House#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
