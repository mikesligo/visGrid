 ...
 * <ul>
 *   <li>{@link visGrid.impl.Triplex_lineImpl#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.impl.Triplex_lineImpl#getName <em>Name</em>}</li>
...
public class Triplex_lineImpl extends EObjectImpl implements Triplex_line {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.TRIPLEX_LINE__CONNECTION);
		}
		return connection;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.TRIPLEX_LINE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.TRIPLEX_LINE__CONNECTION:
				return getConnection();
			case VisGridPackage.TRIPLEX_LINE__NAME:
				return getName();
