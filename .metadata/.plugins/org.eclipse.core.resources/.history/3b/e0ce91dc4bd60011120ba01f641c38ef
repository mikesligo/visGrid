...
public class DishwasherEditPart extends ShapeNodeEditPart {
	...
	public class DishwasherFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			dishwasherFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/dishwasher.svg");
			dishwasherFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(dishwasherFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutDishwasherFigureSVG1 = new BorderLayout();
			dishwasherFigureSVG1.setLayoutManager(layoutDishwasherFigureSVG1);
			...
			inner0.add(fFigureDishwasherNameFigure);

			FlowLayout layoutFFigureDishwasherNameFigure = new FlowLayout();
			layoutFFigureDishwasherNameFigure.setStretchMinorAxis(false);
			layoutFFigureDishwasherNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureDishwasherNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureDishwasherNameFigure.setMajorSpacing(5);
			layoutFFigureDishwasherNameFigure.setMinorSpacing(5);
			layoutFFigureDishwasherNameFigure.setHorizontal(true);

			fFigureDishwasherNameFigure
					.setLayoutManager(layoutFFigureDishwasherNameFigure);
