	...
	public class Line_spacingFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			line_spacingFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/line_spacing.svg");
			line_spacingFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(line_spacingFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutLine_spacingFigureSVG1 = new BorderLayout();
			line_spacingFigureSVG1
					.setLayoutManager(layoutLine_spacingFigureSVG1);
			...
			inner0.add(fFigureLine_spacingNameFigure);

			FlowLayout layoutFFigureLine_spacingNameFigure = new FlowLayout();
			layoutFFigureLine_spacingNameFigure.setStretchMinorAxis(false);
			layoutFFigureLine_spacingNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureLine_spacingNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureLine_spacingNameFigure.setMajorSpacing(5);
			layoutFFigureLine_spacingNameFigure.setMinorSpacing(5);
			layoutFFigureLine_spacingNameFigure.setHorizontal(true);

			fFigureLine_spacingNameFigure
					.setLayoutManager(layoutFFigureLine_spacingNameFigure);
