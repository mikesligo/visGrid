...
public class TransformerEditPart extends ShapeNodeEditPart {
		...
		if (childEditPart instanceof visGrid.diagram.edit.parts.TransformerNameEditPart) {
			((visGrid.diagram.edit.parts.TransformerNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTransformerNameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class TransformerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			transformerFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/transformer.svg");
			transformerFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(transformerFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutTransformerFigureSVG1 = new BorderLayout();
			transformerFigureSVG1.setLayoutManager(layoutTransformerFigureSVG1);
			...
			inner0.add(fFigureTransformerNameFigure);

			FlowLayout layoutFFigureTransformerNameFigure = new FlowLayout();
			layoutFFigureTransformerNameFigure.setStretchMinorAxis(false);
			layoutFFigureTransformerNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureTransformerNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureTransformerNameFigure.setMajorSpacing(5);
			layoutFFigureTransformerNameFigure.setMinorSpacing(5);
			layoutFFigureTransformerNameFigure.setHorizontal(true);

			fFigureTransformerNameFigure
					.setLayoutManager(layoutFFigureTransformerNameFigure);
