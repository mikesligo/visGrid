 ...
 * <ul>
 *   <li>{@link visGrid.Evcharger#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Evcharger#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Evcharger extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getEvcharger_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getEvcharger_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Evcharger#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
