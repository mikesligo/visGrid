...
public class InverterEditPart extends ShapeNodeEditPart {
	...
	public class InverterFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			inverterFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/inverter.svg");
			inverterFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(inverterFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutInverterFigureSVG1 = new BorderLayout();
			inverterFigureSVG1.setLayoutManager(layoutInverterFigureSVG1);
			...
			inner0.add(fFigureInverterNameFigure);

			FlowLayout layoutFFigureInverterNameFigure = new FlowLayout();
			layoutFFigureInverterNameFigure.setStretchMinorAxis(false);
			layoutFFigureInverterNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureInverterNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureInverterNameFigure.setMajorSpacing(5);
			layoutFFigureInverterNameFigure.setMinorSpacing(5);
			layoutFFigureInverterNameFigure.setHorizontal(true);

			fFigureInverterNameFigure
					.setLayoutManager(layoutFFigureInverterNameFigure);
