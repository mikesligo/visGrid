 ...
 * <ul>
 *   <li>{@link visGrid.Controller2#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public interface Controller2 extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getController2_Connection()
	 * @model
	 * @generated
	 */
