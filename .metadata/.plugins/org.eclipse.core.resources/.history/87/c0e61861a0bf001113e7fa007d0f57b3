 ...
 * <ul>
 *   <li>{@link visGrid.Frequency_gen#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Frequency_gen#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Frequency_gen extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getFrequency_gen_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getFrequency_gen_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Frequency_gen#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
