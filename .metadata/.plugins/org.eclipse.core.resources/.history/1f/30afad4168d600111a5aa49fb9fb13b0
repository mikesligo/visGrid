...
public class Triplex_lineEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof visGrid.diagram.edit.parts.Triplex_linePower_losses_AEditPart) {
			((visGrid.diagram.edit.parts.Triplex_linePower_losses_AEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTriplex_linePower_losses_AFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.Triplex_linePower_losses_BEditPart) {
			((visGrid.diagram.edit.parts.Triplex_linePower_losses_BEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTriplex_linePower_losses_BFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.Triplex_linePower_losses_CEditPart) {
			((visGrid.diagram.edit.parts.Triplex_linePower_losses_CEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTriplex_linePower_losses_CFigure());
			return true;
		}
		return false;
	}
	...
	public class Triplex_lineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			triplex_lineFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/triplex_line.svg");
			...
			inner0.add(fFigureTriplex_lineNameFigure);

			FlowLayout layoutFFigureTriplex_lineNameFigure = new FlowLayout();
			layoutFFigureTriplex_lineNameFigure.setStretchMinorAxis(false);
			layoutFFigureTriplex_lineNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureTriplex_lineNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureTriplex_lineNameFigure.setMajorSpacing(5);
			layoutFFigureTriplex_lineNameFigure.setMinorSpacing(5);
			layoutFFigureTriplex_lineNameFigure.setHorizontal(true);

			fFigureTriplex_lineNameFigure
					.setLayoutManager(layoutFFigureTriplex_lineNameFigure);

			fFigureTriplex_linePower_losses_AFigure = new WrappingLabel();
			fFigureTriplex_linePower_losses_AFigure.setText("<...>");

			inner0.add(fFigureTriplex_linePower_losses_AFigure);

			FlowLayout layoutFFigureTriplex_linePower_losses_AFigure = new FlowLayout();
			layoutFFigureTriplex_linePower_losses_AFigure
			...
			layoutFFigureTriplex_linePower_losses_AFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureTriplex_linePower_losses_AFigure.setMajorSpacing(5);
			layoutFFigureTriplex_linePower_losses_AFigure.setMinorSpacing(5);
			layoutFFigureTriplex_linePower_losses_AFigure.setHorizontal(true);

			fFigureTriplex_linePower_losses_AFigure
					.setLayoutManager(layoutFFigureTriplex_linePower_losses_AFigure);

			fFigureTriplex_linePower_losses_BFigure = new WrappingLabel();
			fFigureTriplex_linePower_losses_BFigure.setText("<...>");

			inner0.add(fFigureTriplex_linePower_losses_BFigure);

			FlowLayout layoutFFigureTriplex_linePower_losses_BFigure = new FlowLayout();
			layoutFFigureTriplex_linePower_losses_BFigure
					.setStretchMinorAxis(false);
			layoutFFigureTriplex_linePower_losses_BFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);
			...
			layoutFFigureTriplex_linePower_losses_BFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureTriplex_linePower_losses_BFigure.setMajorSpacing(5);
			layoutFFigureTriplex_linePower_losses_BFigure.setMinorSpacing(5);
			layoutFFigureTriplex_linePower_losses_BFigure.setHorizontal(true);

			fFigureTriplex_linePower_losses_BFigure
					.setLayoutManager(layoutFFigureTriplex_linePower_losses_BFigure);

			fFigureTriplex_linePower_losses_CFigure = new WrappingLabel();
			fFigureTriplex_linePower_losses_CFigure.setText("<...>");

			inner0.add(fFigureTriplex_linePower_losses_CFigure);

			FlowLayout layoutFFigureTriplex_linePower_losses_CFigure = new FlowLayout();
			layoutFFigureTriplex_linePower_losses_CFigure
					.setStretchMinorAxis(false);
			layoutFFigureTriplex_linePower_losses_CFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);
			...
			layoutFFigureTriplex_linePower_losses_CFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureTriplex_linePower_losses_CFigure.setMajorSpacing(5);
			layoutFFigureTriplex_linePower_losses_CFigure.setMinorSpacing(5);
			layoutFFigureTriplex_linePower_losses_CFigure.setHorizontal(true);

			fFigureTriplex_linePower_losses_CFigure
					.setLayoutManager(layoutFFigureTriplex_linePower_losses_CFigure);
