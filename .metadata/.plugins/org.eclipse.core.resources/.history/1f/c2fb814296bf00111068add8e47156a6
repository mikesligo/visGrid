 ...
 * <ul>
 *   <li>{@link visGrid.Refrigerator#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Refrigerator#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Refrigerator extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getRefrigerator_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getRefrigerator_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Refrigerator#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
