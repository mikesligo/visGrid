 ...
 * <ul>
 *   <li>{@link visGrid.impl.Controller2Impl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class Controller2Impl extends EObjectImpl implements Controller2 {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.CONTROLLER2__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.CONTROLLER2__CONNECTION:
