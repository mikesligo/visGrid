 ...
 * <ul>
 *   <li>{@link visGrid.impl.OccupantloadImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class OccupantloadImpl extends EObjectImpl implements Occupantload {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.OCCUPANTLOAD__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.OCCUPANTLOAD__CONNECTION:
