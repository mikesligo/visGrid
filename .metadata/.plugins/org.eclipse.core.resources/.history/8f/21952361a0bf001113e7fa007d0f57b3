 ...
 * <ul>
 *   <li>{@link visGrid.impl.RecorderImpl#getConnection <em>Connection</em>}</li>
...
public class RecorderImpl extends EObjectImpl implements Recorder {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.RECORDER__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.RECORDER__CONNECTION:
