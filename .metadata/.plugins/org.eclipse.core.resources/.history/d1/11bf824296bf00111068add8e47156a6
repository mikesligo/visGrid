 ...
 * <ul>
 *   <li>{@link visGrid.Solar#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Solar#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Solar extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getSolar_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getSolar_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Solar#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
