 ...
 * <ul>
 *   <li>{@link visGrid.Clotheswasher#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Clotheswasher#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Clotheswasher extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getClotheswasher_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getClotheswasher_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Clotheswasher#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
