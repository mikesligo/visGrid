 ...
 * <ul>
 *   <li>{@link visGrid.impl.BatteryImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class BatteryImpl extends EObjectImpl implements Battery {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.BATTERY__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.BATTERY__CONNECTION:
