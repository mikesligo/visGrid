...
public class Dc_dc_converterEditPart extends ShapeNodeEditPart {
	...
	public class Dc_dc_converterFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			dc_dc_converterFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(dc_dc_converterFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutDc_dc_converterFigureSVG1 = new BorderLayout();
			dc_dc_converterFigureSVG1
					.setLayoutManager(layoutDc_dc_converterFigureSVG1);
			...
			inner0.add(fFigureDc_dc_converterNameFigure);

			FlowLayout layoutFFigureDc_dc_converterNameFigure = new FlowLayout();
			layoutFFigureDc_dc_converterNameFigure.setStretchMinorAxis(false);
			layoutFFigureDc_dc_converterNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureDc_dc_converterNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureDc_dc_converterNameFigure.setMajorSpacing(5);
			layoutFFigureDc_dc_converterNameFigure.setMinorSpacing(5);
			layoutFFigureDc_dc_converterNameFigure.setHorizontal(true);

			fFigureDc_dc_converterNameFigure
					.setLayoutManager(layoutFFigureDc_dc_converterNameFigure);
