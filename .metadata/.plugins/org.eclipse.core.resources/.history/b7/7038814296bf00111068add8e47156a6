 ...
 * <ul>
 *   <li>{@link visGrid.Node#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Node#getName <em>Name</em>}</li>
...
public interface Node extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getNode_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getNode_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Node#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
