...
public class Triplex_line_conductorEditPart extends ShapeNodeEditPart {
	...
	public class Triplex_line_conductorFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure triplex_line_conductorFigureSVG1 = new SVGFigure();
			triplex_line_conductorFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/triplex_line_conductor.svg");
			triplex_line_conductorFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0
					.add(triplex_line_conductorFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutTriplex_line_conductorFigureSVG1 = new BorderLayout();
			triplex_line_conductorFigureSVG1
					.setLayoutManager(layoutTriplex_line_conductorFigureSVG1);
			...
			inner0.add(fFigureTriplex_line_conductorNameFigure);

			FlowLayout layoutFFigureTriplex_line_conductorNameFigure = new FlowLayout();
			layoutFFigureTriplex_line_conductorNameFigure
			...
			layoutFFigureTriplex_line_conductorNameFigure.setMajorSpacing(5);
			layoutFFigureTriplex_line_conductorNameFigure.setMinorSpacing(5);
			layoutFFigureTriplex_line_conductorNameFigure.setHorizontal(true);

			fFigureTriplex_line_conductorNameFigure
					.setLayoutManager(layoutFFigureTriplex_line_conductorNameFigure);
