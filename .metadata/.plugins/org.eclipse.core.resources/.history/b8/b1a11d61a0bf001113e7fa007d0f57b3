 ...
 * <ul>
 *   <li>{@link visGrid.Windturb_dg#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Windturb_dg#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Windturb_dg extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getWindturb_dg_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getWindturb_dg_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Windturb_dg#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
