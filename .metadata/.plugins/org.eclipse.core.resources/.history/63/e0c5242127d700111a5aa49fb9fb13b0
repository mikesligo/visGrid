 ...
 * @generated
 */
public class VisGridEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public VisGridEditPartProvider() {
		setFactory(new visGrid.diagram.edit.parts.VisGridEditPartFactory());
