 ...
 * <ul>
 *   <li>{@link visGrid.Series_reactor#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public interface Series_reactor extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getSeries_reactor_Connection()
	 * @model
	 * @generated
	 */
