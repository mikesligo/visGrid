...
public class MeterEditPart extends ShapeNodeEditPart {
	...
	public class MeterFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			meterFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/meter.svg");
			meterFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(meterFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutMeterFigureSVG1 = new BorderLayout();
			meterFigureSVG1.setLayoutManager(layoutMeterFigureSVG1);
			...
			inner0.add(fFigureMeterNameFigure);

			FlowLayout layoutFFigureMeterNameFigure = new FlowLayout();
			layoutFFigureMeterNameFigure.setStretchMinorAxis(false);
			layoutFFigureMeterNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureMeterNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureMeterNameFigure.setMajorSpacing(5);
			layoutFFigureMeterNameFigure.setMinorSpacing(5);
			layoutFFigureMeterNameFigure.setHorizontal(true);

			fFigureMeterNameFigure
					.setLayoutManager(layoutFFigureMeterNameFigure);
