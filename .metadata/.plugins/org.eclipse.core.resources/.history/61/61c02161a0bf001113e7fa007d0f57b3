 ...
 * <ul>
 *   <li>{@link visGrid.impl.LightsImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class LightsImpl extends EObjectImpl implements Lights {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.LIGHTS__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.LIGHTS__CONNECTION:
