	...
	public class Underground_lineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			underground_lineFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/underground_line.svg");
			underground_lineFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(underground_lineFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutUnderground_lineFigureSVG1 = new BorderLayout();
			underground_lineFigureSVG1
					.setLayoutManager(layoutUnderground_lineFigureSVG1);
			...
			inner0.add(fFigureUnderground_lineNameFigure);

			FlowLayout layoutFFigureUnderground_lineNameFigure = new FlowLayout();
			layoutFFigureUnderground_lineNameFigure.setStretchMinorAxis(false);
			layoutFFigureUnderground_lineNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureUnderground_lineNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureUnderground_lineNameFigure.setMajorSpacing(5);
			layoutFFigureUnderground_lineNameFigure.setMinorSpacing(5);
			layoutFFigureUnderground_lineNameFigure.setHorizontal(true);

			fFigureUnderground_lineNameFigure
					.setLayoutManager(layoutFFigureUnderground_lineNameFigure);
