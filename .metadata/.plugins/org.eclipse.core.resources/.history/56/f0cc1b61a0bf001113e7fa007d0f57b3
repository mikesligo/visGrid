 ...
 * <ul>
 *   <li>{@link visGrid.Regulator_configuration#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Regulator_configuration#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Regulator_configuration extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getRegulator_configuration_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getRegulator_configuration_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Regulator_configuration#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
