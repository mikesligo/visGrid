...
public class SolarEditPart extends ShapeNodeEditPart {
	...
	public class SolarFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			solarFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/solar.svg");
			solarFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(solarFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutSolarFigureSVG1 = new BorderLayout();
			solarFigureSVG1.setLayoutManager(layoutSolarFigureSVG1);
			...
			inner0.add(fFigureSolarNameFigure);

			FlowLayout layoutFFigureSolarNameFigure = new FlowLayout();
			layoutFFigureSolarNameFigure.setStretchMinorAxis(false);
			layoutFFigureSolarNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureSolarNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureSolarNameFigure.setMajorSpacing(5);
			layoutFFigureSolarNameFigure.setMinorSpacing(5);
			layoutFFigureSolarNameFigure.setHorizontal(true);

			fFigureSolarNameFigure
					.setLayoutManager(layoutFFigureSolarNameFigure);
