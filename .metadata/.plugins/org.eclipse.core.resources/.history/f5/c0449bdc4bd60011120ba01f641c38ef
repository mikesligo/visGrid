...
public class Triplex_meterEditPart extends ShapeNodeEditPart {
	...
	public class Triplex_meterFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			triplex_meterFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(triplex_meterFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutTriplex_meterFigureSVG1 = new BorderLayout();
			triplex_meterFigureSVG1
					.setLayoutManager(layoutTriplex_meterFigureSVG1);
