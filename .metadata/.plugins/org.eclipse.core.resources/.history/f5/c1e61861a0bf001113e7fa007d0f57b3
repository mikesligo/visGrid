 ...
 * <ul>
 *   <li>{@link visGrid.Fuse#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Fuse#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface Fuse extends EObject {
	/**
	 ...
	 * @see visGrid.VisGridPackage#getFuse_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getFuse_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Fuse#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
