 ...
 * <ul>
 *   <li>{@link visGrid.impl.Power_electronicsImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class Power_electronicsImpl extends EObjectImpl implements Power_electronics {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.POWER_ELECTRONICS__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.POWER_ELECTRONICS__CONNECTION:
