...
public class PlcEditPart extends ShapeNodeEditPart {
	...
	public class PlcFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			plcFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(60),
					getMapMode().DPtoLP(60)));

			innerSVG0.add(plcFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutPlcFigureSVG1 = new BorderLayout();
			plcFigureSVG1.setLayoutManager(layoutPlcFigureSVG1);
			...
			inner0.add(fFigurePlcNameFigure);

			FlowLayout layoutFFigurePlcNameFigure = new FlowLayout();
			layoutFFigurePlcNameFigure.setStretchMinorAxis(false);
			layoutFFigurePlcNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigurePlcNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigurePlcNameFigure.setMajorSpacing(5);
			layoutFFigurePlcNameFigure.setMinorSpacing(5);
			layoutFFigurePlcNameFigure.setHorizontal(true);

			fFigurePlcNameFigure.setLayoutManager(layoutFFigurePlcNameFigure);
