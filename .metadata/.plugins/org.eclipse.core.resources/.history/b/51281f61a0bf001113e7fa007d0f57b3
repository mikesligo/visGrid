 ...
 * <ul>
 *   <li>{@link visGrid.impl.ClotheswasherImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class ClotheswasherImpl extends EObjectImpl implements Clotheswasher {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.CLOTHESWASHER__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.CLOTHESWASHER__CONNECTION:
