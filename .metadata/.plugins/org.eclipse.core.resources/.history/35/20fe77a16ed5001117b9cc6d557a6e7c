	...
	public class MicroturbineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			microturbineFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/microturbine.svg");
			microturbineFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(microturbineFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutMicroturbineFigureSVG1 = new BorderLayout();
			microturbineFigureSVG1
					.setLayoutManager(layoutMicroturbineFigureSVG1);
			...
			inner0.add(fFigureMicroturbineNameFigure);

			FlowLayout layoutFFigureMicroturbineNameFigure = new FlowLayout();
			layoutFFigureMicroturbineNameFigure.setStretchMinorAxis(false);
			layoutFFigureMicroturbineNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureMicroturbineNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureMicroturbineNameFigure.setMajorSpacing(5);
			layoutFFigureMicroturbineNameFigure.setMinorSpacing(5);
			layoutFFigureMicroturbineNameFigure.setHorizontal(true);

			fFigureMicroturbineNameFigure
					.setLayoutManager(layoutFFigureMicroturbineNameFigure);
