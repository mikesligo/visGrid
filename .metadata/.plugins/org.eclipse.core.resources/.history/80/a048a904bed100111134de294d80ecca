 ...
 * @generated
 */
public class Underground_line_conductorNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Underground_line_conductorNameEditPart(View view) {
		super(view);
	}
	 ...
	 * @generated
	 */
	public void setLabel(RectangleFigure figure) {
		unregisterVisuals();
		setFigure(figure);
