...
public class Csv_readerEditPart extends ShapeNodeEditPart {
	...
	public class Csv_readerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			csv_readerFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(csv_readerFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutCsv_readerFigureSVG1 = new BorderLayout();
			csv_readerFigureSVG1.setLayoutManager(layoutCsv_readerFigureSVG1);
