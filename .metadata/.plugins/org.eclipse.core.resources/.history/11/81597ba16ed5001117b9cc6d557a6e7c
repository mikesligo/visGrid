	...
	public class RestorationFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			restorationFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/restoration.svg");
			restorationFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(restorationFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutRestorationFigureSVG1 = new BorderLayout();
			restorationFigureSVG1.setLayoutManager(layoutRestorationFigureSVG1);
			...
			inner0.add(fFigureRestorationNameFigure);

			FlowLayout layoutFFigureRestorationNameFigure = new FlowLayout();
			layoutFFigureRestorationNameFigure.setStretchMinorAxis(false);
			layoutFFigureRestorationNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureRestorationNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureRestorationNameFigure.setMajorSpacing(5);
			layoutFFigureRestorationNameFigure.setMinorSpacing(5);
			layoutFFigureRestorationNameFigure.setHorizontal(true);

			fFigureRestorationNameFigure
					.setLayoutManager(layoutFFigureRestorationNameFigure);
