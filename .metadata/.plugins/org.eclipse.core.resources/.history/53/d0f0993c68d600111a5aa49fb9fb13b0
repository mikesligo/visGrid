...
public class Overhead_lineEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof visGrid.diagram.edit.parts.Overhead_linePower_losses_AEditPart) {
			((visGrid.diagram.edit.parts.Overhead_linePower_losses_AEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOverhead_linePower_losses_AFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.Overhead_linePower_losses_BEditPart) {
			((visGrid.diagram.edit.parts.Overhead_linePower_losses_BEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOverhead_linePower_losses_BFigure());
			return true;
		}
		return false;
	}
	...
	public class Overhead_lineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure overhead_lineFigureSVG1 = new SVGFigure();
			overhead_lineFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/overhead_line.svg");

			innerSVG0.add(overhead_lineFigureSVG1, new Rectangle(0, 0,
			...
			inner0.add(fFigureOverhead_lineNameFigure);

			FlowLayout layoutFFigureOverhead_lineNameFigure = new FlowLayout();
			layoutFFigureOverhead_lineNameFigure.setStretchMinorAxis(false);
			layoutFFigureOverhead_lineNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureOverhead_lineNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureOverhead_lineNameFigure.setMajorSpacing(5);
			layoutFFigureOverhead_lineNameFigure.setMinorSpacing(5);
			layoutFFigureOverhead_lineNameFigure.setHorizontal(true);

			fFigureOverhead_lineNameFigure
					.setLayoutManager(layoutFFigureOverhead_lineNameFigure);

			fFigureOverhead_linePower_losses_AFigure = new WrappingLabel();
			fFigureOverhead_linePower_losses_AFigure.setText("<...>");

			inner0.add(fFigureOverhead_linePower_losses_AFigure);

			FlowLayout layoutFFigureOverhead_linePower_losses_AFigure = new FlowLayout();
			layoutFFigureOverhead_linePower_losses_AFigure
			...
			layoutFFigureOverhead_linePower_losses_AFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureOverhead_linePower_losses_AFigure.setMajorSpacing(5);
			layoutFFigureOverhead_linePower_losses_AFigure.setMinorSpacing(5);
			layoutFFigureOverhead_linePower_losses_AFigure.setHorizontal(true);

			fFigureOverhead_linePower_losses_AFigure
					.setLayoutManager(layoutFFigureOverhead_linePower_losses_AFigure);

			fFigureOverhead_linePower_losses_BFigure = new WrappingLabel();
			fFigureOverhead_linePower_losses_BFigure.setText("<...>");

			inner0.add(fFigureOverhead_linePower_losses_BFigure);

			FlowLayout layoutFFigureOverhead_linePower_losses_BFigure = new FlowLayout();
			layoutFFigureOverhead_linePower_losses_BFigure
					.setStretchMinorAxis(false);
			layoutFFigureOverhead_linePower_losses_BFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);
			...
			layoutFFigureOverhead_linePower_losses_BFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureOverhead_linePower_losses_BFigure.setMajorSpacing(5);
			layoutFFigureOverhead_linePower_losses_BFigure.setMinorSpacing(5);
			layoutFFigureOverhead_linePower_losses_BFigure.setHorizontal(true);

			fFigureOverhead_linePower_losses_BFigure
					.setLayoutManager(layoutFFigureOverhead_linePower_losses_BFigure);
