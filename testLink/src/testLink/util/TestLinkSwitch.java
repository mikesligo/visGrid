...
public class TestLinkSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestLinkPackage.ATOP: {
				ATop aTop = (ATop)theEObject;
				T result = caseATop(aTop);
			...
			case TestLinkPackage.ONE: {
				...
				if (result == null) result = caseLink(one);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestLinkPackage.TWO: {
				...
				if (result == null) result = caseLink(two);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestLinkPackage.THREE: {
				...
				if (result == null) result = caseLink(three);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestLinkPackage.LINK: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ATop</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>ATop</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseATop(ATop object) {
		return null;
	}
