...
public class VisGridVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case visGrid.diagram.edit.parts.GridEditPart.VISUAL_ID:
			...
			if (visGrid.VisGridPackage.eINSTANCE.getConnections()
					.isSuperTypeOf(domainElement.eClass())) {
				return visGrid.diagram.edit.parts.ConnectionsEditPart.VISUAL_ID;
			}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case visGrid.diagram.edit.parts.GridEditPart.VISUAL_ID:
			...
			if (visGrid.diagram.edit.parts.ConnectionsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
