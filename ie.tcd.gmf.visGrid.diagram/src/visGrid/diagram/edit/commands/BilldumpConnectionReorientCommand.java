 ...
 * @generated
 */
public class BilldumpConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BilldumpConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Billdump) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Billdump)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistBilldumpConnection_4035(
	 ...
	 * @generated
	 */
	protected visGrid.Billdump getOldSource() {
		return (visGrid.Billdump) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Billdump getNewSource() {
