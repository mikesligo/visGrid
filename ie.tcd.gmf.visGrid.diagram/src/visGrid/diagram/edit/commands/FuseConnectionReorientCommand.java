 ...
 * @generated
 */
public class FuseConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FuseConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Fuse) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Fuse)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistFuseConnection_4154(
	 ...
	 * @generated
	 */
	protected visGrid.Fuse getOldSource() {
		return (visGrid.Fuse) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Fuse getNewSource() {
