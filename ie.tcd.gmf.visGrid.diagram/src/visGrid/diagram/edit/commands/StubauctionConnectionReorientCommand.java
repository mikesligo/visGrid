 ...
 * @generated
 */
public class StubauctionConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StubauctionConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Stubauction) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Stubauction)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistStubauctionConnection_4098(
	 ...
	 * @generated
	 */
	protected visGrid.Stubauction getOldSource() {
		return (visGrid.Stubauction) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Stubauction getNewSource() {
