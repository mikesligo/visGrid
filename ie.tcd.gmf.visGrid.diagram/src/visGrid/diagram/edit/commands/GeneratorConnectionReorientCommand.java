 ...
 * @generated
 */
public class GeneratorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GeneratorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Generator) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Generator)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistGeneratorConnection_4099(
	 ...
	 * @generated
	 */
	protected visGrid.Generator getOldSource() {
		return (visGrid.Generator) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Generator getNewSource() {
