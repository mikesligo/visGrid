 ...
 * @generated
 */
public class Series_reactorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Series_reactorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Series_reactor) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Series_reactor)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistSeries_reactorConnection_4132(
	 ...
	 * @generated
	 */
	protected visGrid.Series_reactor getOldSource() {
		return (visGrid.Series_reactor) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Series_reactor getNewSource() {
