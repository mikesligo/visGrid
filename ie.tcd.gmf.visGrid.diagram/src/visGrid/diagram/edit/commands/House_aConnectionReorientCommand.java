 ...
 * @generated
 */
public class House_aConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public House_aConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.House_a) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.House_a)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistHouse_aConnection_4044(
	 ...
	 * @generated
	 */
	protected visGrid.House_a getOldSource() {
		return (visGrid.House_a) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.House_a getNewSource() {
