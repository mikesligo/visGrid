 ...
 * @generated
 */
public class CapbankConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CapbankConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Capbank) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Capbank)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistCapbankConnection_4016(
	 ...
	 * @generated
	 */
	protected visGrid.Capbank getOldSource() {
		return (visGrid.Capbank) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Capbank getNewSource() {
