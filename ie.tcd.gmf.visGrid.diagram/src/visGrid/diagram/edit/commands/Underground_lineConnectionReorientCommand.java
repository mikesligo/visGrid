 ...
 * @generated
 */
public class Underground_lineConnectionReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public Underground_lineConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Underground_line) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Underground_line)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistUnderground_lineConnection_4149(
	 ...
	 * @generated
	 */
	protected visGrid.Underground_line getOldSource() {
		return (visGrid.Underground_line) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Underground_line getNewSource() {
