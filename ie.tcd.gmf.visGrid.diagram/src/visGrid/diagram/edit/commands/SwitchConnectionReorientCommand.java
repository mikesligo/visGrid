 ...
 * @generated
 */
public class SwitchConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SwitchConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Switch) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Switch)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistSwitchConnection_4012(
	 ...
	 * @generated
	 */
	protected visGrid.Switch getOldSource() {
		return (visGrid.Switch) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Switch getNewSource() {
