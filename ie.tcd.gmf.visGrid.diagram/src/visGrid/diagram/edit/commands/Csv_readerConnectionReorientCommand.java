 ...
 * @generated
 */
public class Csv_readerConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Csv_readerConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Csv_reader) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Csv_reader)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistCsv_readerConnection_4027(
	 ...
	 * @generated
	 */
	protected visGrid.Csv_reader getOldSource() {
		return (visGrid.Csv_reader) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Csv_reader getNewSource() {
