 ...
 * @generated
 */
public class MeterConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MeterConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Meter) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Meter)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMeterConnection_4024(
	 ...
	 * @generated
	 */
	protected visGrid.Meter getOldSource() {
		return (visGrid.Meter) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Meter getNewSource() {
