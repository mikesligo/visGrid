 ...
 * @generated
 */
public class LinkConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LinkConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Link) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Link)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLinkConnection_4013(
	 ...
	 * @generated
	 */
	protected visGrid.Link getOldSource() {
		return (visGrid.Link) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Link getNewSource() {
