 ...
 * @generated
 */
public class Volt_var_controlConnectionReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public Volt_var_controlConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Volt_var_control) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Volt_var_control)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistVolt_var_controlConnection_4088(
	 ...
	 * @generated
	 */
	protected visGrid.Volt_var_control getOldSource() {
		return (visGrid.Volt_var_control) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Volt_var_control getNewSource() {
