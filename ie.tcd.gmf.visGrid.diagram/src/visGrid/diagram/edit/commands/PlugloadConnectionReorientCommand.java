 ...
 * @generated
 */
public class PlugloadConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PlugloadConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Plugload) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Plugload)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistPlugloadConnection_4032(
	 ...
	 * @generated
	 */
	protected visGrid.Plugload getOldSource() {
		return (visGrid.Plugload) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Plugload getNewSource() {
