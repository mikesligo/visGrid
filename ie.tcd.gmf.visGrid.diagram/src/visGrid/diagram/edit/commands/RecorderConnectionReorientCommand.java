 ...
 * @generated
 */
public class RecorderConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RecorderConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Recorder) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Recorder)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRecorderConnection_4103(
	 ...
	 * @generated
	 */
	protected visGrid.Recorder getOldSource() {
		return (visGrid.Recorder) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Recorder getNewSource() {
