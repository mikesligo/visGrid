 ...
 * @generated
 */
public class RelayConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RelayConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Relay) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Relay)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRelayConnection_4026(
	 ...
	 * @generated
	 */
	protected visGrid.Relay getOldSource() {
		return (visGrid.Relay) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Relay getNewSource() {
