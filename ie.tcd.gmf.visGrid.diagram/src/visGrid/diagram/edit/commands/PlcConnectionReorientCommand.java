 ...
 * @generated
 */
public class PlcConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PlcConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Plc) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Plc)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistPlcConnection_4120(
	 ...
	 * @generated
	 */
	protected visGrid.Plc getOldSource() {
		return (visGrid.Plc) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Plc getNewSource() {
