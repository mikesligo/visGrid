 ...
 * @generated
 */
public class WeatherConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public WeatherConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Weather) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Weather)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistWeatherConnection_4041(
	 ...
	 * @generated
	 */
	protected visGrid.Weather getOldSource() {
		return (visGrid.Weather) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Weather getNewSource() {
