 ...
 * @generated
 */
public class LineConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LineConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Line) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Line)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLineConnection_4137(
	 ...
	 * @generated
	 */
	protected visGrid.Line getOldSource() {
		return (visGrid.Line) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Line getNewSource() {
