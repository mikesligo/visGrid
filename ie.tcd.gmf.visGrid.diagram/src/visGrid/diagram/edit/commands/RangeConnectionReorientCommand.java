 ...
 * @generated
 */
public class RangeConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RangeConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Range) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Range)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRangeConnection_4151(
	 ...
	 * @generated
	 */
	protected visGrid.Range getOldSource() {
		return (visGrid.Range) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Range getNewSource() {
