 ...
 * @generated
 */
public class Windturb_dgConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Windturb_dgConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Windturb_dg) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Windturb_dg)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistWindturb_dgConnection_4093(
	 ...
	 * @generated
	 */
	protected visGrid.Windturb_dg getOldSource() {
		return (visGrid.Windturb_dg) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Windturb_dg getNewSource() {
