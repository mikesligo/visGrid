 ...
 * @generated
 */
public class AuctionConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AuctionConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Auction) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Auction)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistAuctionConnection_4138(
	 ...
	 * @generated
	 */
	protected visGrid.Auction getOldSource() {
		return (visGrid.Auction) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Auction getNewSource() {
