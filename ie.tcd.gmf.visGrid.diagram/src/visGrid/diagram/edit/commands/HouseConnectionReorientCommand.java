 ...
 * @generated
 */
public class HouseConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HouseConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.House) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.House)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistHouseConnection_4073(
	 ...
	 * @generated
	 */
	protected visGrid.House getOldSource() {
		return (visGrid.House) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.House getNewSource() {
		return (visGrid.House) newEnd;
	}
