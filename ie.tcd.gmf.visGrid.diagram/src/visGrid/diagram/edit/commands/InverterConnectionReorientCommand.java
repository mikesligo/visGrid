 ...
 * @generated
 */
public class InverterConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InverterConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Inverter) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Inverter)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistInverterConnection_4065(
	 ...
	 * @generated
	 */
	protected visGrid.Inverter getOldSource() {
		return (visGrid.Inverter) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Inverter getNewSource() {
