 ...
 * @generated
 */
public class Diesel_dgConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Diesel_dgConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Diesel_dg) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Diesel_dg)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistDiesel_dgConnection_4115(
	 ...
	 * @generated
	 */
	protected visGrid.Diesel_dg getOldSource() {
		return (visGrid.Diesel_dg) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Diesel_dg getNewSource() {
