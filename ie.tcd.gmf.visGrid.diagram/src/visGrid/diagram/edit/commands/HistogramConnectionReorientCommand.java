 ...
 * @generated
 */
public class HistogramConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HistogramConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Histogram) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Histogram)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistHistogramConnection_4124(
	 ...
	 * @generated
	 */
	protected visGrid.Histogram getOldSource() {
		return (visGrid.Histogram) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Histogram getNewSource() {
