 ...
 * @generated
 */
public class MotorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MotorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Motor) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Motor)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMotorConnection_4063(
	 ...
	 * @generated
	 */
	protected visGrid.Motor getOldSource() {
		return (visGrid.Motor) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Motor getNewSource() {
