 ...
 * @generated
 */
public class ControllerConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ControllerConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Controller) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Controller)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistControllerConnection_4085(
	 ...
	 * @generated
	 */
	protected visGrid.Controller getOldSource() {
		return (visGrid.Controller) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Controller getNewSource() {
		return (visGrid.Controller) newEnd;
	}
