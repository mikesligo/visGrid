 ...
 * @generated
 */
public class CommConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CommConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Comm) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Comm)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistCommConnection_4086(
	 ...
	 * @generated
	 */
	protected visGrid.Comm getOldSource() {
		return (visGrid.Comm) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Comm getNewSource() {
