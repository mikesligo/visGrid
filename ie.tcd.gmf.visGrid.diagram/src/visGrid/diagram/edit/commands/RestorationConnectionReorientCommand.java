 ...
 * @generated
 */
public class RestorationConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RestorationConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Restoration) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Restoration)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRestorationConnection_4077(
	 ...
	 * @generated
	 */
	protected visGrid.Restoration getOldSource() {
		return (visGrid.Restoration) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Restoration getNewSource() {
