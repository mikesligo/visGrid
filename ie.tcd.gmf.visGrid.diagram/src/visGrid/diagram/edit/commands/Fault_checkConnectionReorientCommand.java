 ...
 * @generated
 */
public class Fault_checkConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Fault_checkConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Fault_check) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Fault_check)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistFault_checkConnection_4049(
	 ...
	 * @generated
	 */
	protected visGrid.Fault_check getOldSource() {
		return (visGrid.Fault_check) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Fault_check getNewSource() {
		return (visGrid.Fault_check) newEnd;
	}
