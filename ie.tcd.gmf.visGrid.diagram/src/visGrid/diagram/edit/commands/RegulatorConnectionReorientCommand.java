 ...
 * @generated
 */
public class RegulatorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RegulatorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Regulator) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Regulator)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRegulatorConnection_4084(
	 ...
	 * @generated
	 */
	protected visGrid.Regulator getOldSource() {
		return (visGrid.Regulator) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Regulator getNewSource() {
