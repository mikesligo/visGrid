 ...
 * @generated
 */
public class WaterheaterConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public WaterheaterConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Waterheater) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Waterheater)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistWaterheaterConnection_4019(
	 ...
	 * @generated
	 */
	protected visGrid.Waterheater getOldSource() {
		return (visGrid.Waterheater) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Waterheater getNewSource() {
