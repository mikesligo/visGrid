 ...
 * @generated
 */
public class SubstationConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SubstationConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Substation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Substation)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistSubstationConnection_4067(
	 ...
	 * @generated
	 */
	protected visGrid.Substation getOldSource() {
		return (visGrid.Substation) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Substation getNewSource() {
