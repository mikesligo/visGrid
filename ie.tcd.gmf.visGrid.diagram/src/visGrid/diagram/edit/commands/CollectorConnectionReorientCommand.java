 ...
 * @generated
 */
public class CollectorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CollectorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Collector) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Collector)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistCollectorConnection_4113(
	 ...
	 * @generated
	 */
	protected visGrid.Collector getOldSource() {
		return (visGrid.Collector) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Collector getNewSource() {
		return (visGrid.Collector) newEnd;
	}
