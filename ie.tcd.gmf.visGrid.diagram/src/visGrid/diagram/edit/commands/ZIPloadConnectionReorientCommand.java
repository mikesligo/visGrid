 ...
 * @generated
 */
public class ZIPloadConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ZIPloadConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.ZIPload) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.ZIPload)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistZIPloadConnection_4009(
	 ...
	 * @generated
	 */
	protected visGrid.ZIPload getOldSource() {
		return (visGrid.ZIPload) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.ZIPload getNewSource() {
		return (visGrid.ZIPload) newEnd;
	}
