 ...
 * @generated
 */
public class VoltdumpConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public VoltdumpConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Voltdump) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Voltdump)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistVoltdumpConnection_4129(
	 ...
	 * @generated
	 */
	protected visGrid.Voltdump getOldSource() {
		return (visGrid.Voltdump) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Voltdump getNewSource() {
