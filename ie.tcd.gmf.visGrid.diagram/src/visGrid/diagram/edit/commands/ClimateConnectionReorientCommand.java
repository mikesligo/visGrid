 ...
 * @generated
 */
public class ClimateConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClimateConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Climate) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Climate)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistClimateConnection_4015(
	 ...
	 * @generated
	 */
	protected visGrid.Climate getOldSource() {
		return (visGrid.Climate) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Climate getNewSource() {
