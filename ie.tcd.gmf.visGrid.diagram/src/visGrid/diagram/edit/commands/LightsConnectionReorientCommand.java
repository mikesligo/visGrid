 ...
 * @generated
 */
public class LightsConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LightsConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Lights) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Lights)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLightsConnection_4029(
	 ...
	 * @generated
	 */
	protected visGrid.Lights getOldSource() {
		return (visGrid.Lights) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Lights getNewSource() {
