 ...
 * @generated
 */
public class EvchargerConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EvchargerConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Evcharger) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Evcharger)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistEvchargerConnection_4096(
	 ...
	 * @generated
	 */
	protected visGrid.Evcharger getOldSource() {
		return (visGrid.Evcharger) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Evcharger getNewSource() {
		return (visGrid.Evcharger) newEnd;
	}
