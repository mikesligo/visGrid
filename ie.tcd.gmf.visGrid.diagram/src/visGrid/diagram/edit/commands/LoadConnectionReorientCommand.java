 ...
 * @generated
 */
public class LoadConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LoadConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Load) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Load)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLoadConnection_4117(
	 ...
	 * @generated
	 */
	protected visGrid.Load getOldSource() {
		return (visGrid.Load) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Load getNewSource() {
