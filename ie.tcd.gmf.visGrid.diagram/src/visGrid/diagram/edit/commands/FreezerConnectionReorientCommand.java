 ...
 * @generated
 */
public class FreezerConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FreezerConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Freezer) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Freezer)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistFreezerConnection_4089(
	 ...
	 * @generated
	 */
	protected visGrid.Freezer getOldSource() {
		return (visGrid.Freezer) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Freezer getNewSource() {
		return (visGrid.Freezer) newEnd;
	}
