 ...
 * @generated
 */
public class PlayerConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PlayerConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Player) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Player)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistPlayerConnection_4119(
	 ...
	 * @generated
	 */
	protected visGrid.Player getOldSource() {
		return (visGrid.Player) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Player getNewSource() {
