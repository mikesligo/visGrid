 ...
 * @generated
 */
public class ShaperConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ShaperConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Shaper) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Shaper)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistShaperConnection_4101(
	 ...
	 * @generated
	 */
	protected visGrid.Shaper getOldSource() {
		return (visGrid.Shaper) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Shaper getNewSource() {
