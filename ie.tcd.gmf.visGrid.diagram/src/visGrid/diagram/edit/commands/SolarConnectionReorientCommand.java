 ...
 * @generated
 */
public class SolarConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SolarConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Solar) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Solar)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistSolarConnection_4025(
	 ...
	 * @generated
	 */
	protected visGrid.Solar getOldSource() {
		return (visGrid.Solar) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Solar getNewSource() {
