 ...
 * @generated
 */
public class TransformerConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TransformerConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Transformer) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Transformer)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistTransformerConnection_4040(
	 ...
	 * @generated
	 */
	protected visGrid.Transformer getOldSource() {
		return (visGrid.Transformer) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Transformer getNewSource() {
