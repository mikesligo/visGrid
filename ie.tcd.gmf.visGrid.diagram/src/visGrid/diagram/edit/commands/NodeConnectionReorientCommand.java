 ...
 * @generated
 */
public class NodeConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NodeConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Node) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Node)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistNodeConnection_4020(
	 ...
	 * @generated
	 */
	protected visGrid.Node getOldSource() {
		return (visGrid.Node) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Node getNewSource() {
		return (visGrid.Node) newEnd;
	}
