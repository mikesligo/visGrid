 ...
 * @generated
 */
public class RefrigeratorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RefrigeratorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Refrigerator) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Refrigerator)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRefrigeratorConnection_4072(
	 ...
	 * @generated
	 */
	protected visGrid.Refrigerator getOldSource() {
		return (visGrid.Refrigerator) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Refrigerator getNewSource() {
