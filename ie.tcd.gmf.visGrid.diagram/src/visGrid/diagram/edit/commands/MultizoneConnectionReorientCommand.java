 ...
 * @generated
 */
public class MultizoneConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MultizoneConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Multizone) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Multizone)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMultizoneConnection_4056(
	 ...
	 * @generated
	 */
	protected visGrid.Multizone getOldSource() {
		return (visGrid.Multizone) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Multizone getNewSource() {
