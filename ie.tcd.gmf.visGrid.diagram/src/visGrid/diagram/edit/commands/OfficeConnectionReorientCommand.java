 ...
 * @generated
 */
public class OfficeConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OfficeConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Office) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Office)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistOfficeConnection_4070(
	 ...
	 * @generated
	 */
	protected visGrid.Office getOldSource() {
		return (visGrid.Office) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Office getNewSource() {
