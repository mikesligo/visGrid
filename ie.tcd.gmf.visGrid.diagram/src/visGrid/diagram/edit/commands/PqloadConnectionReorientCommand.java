 ...
 * @generated
 */
public class PqloadConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PqloadConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Pqload) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Pqload)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistPqloadConnection_4069(
	 ...
	 * @generated
	 */
	protected visGrid.Pqload getOldSource() {
		return (visGrid.Pqload) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Pqload getNewSource() {
