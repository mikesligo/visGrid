 ...
 * @generated
 */
public class CapacitorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CapacitorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Capacitor) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Capacitor)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistCapacitorConnection_4130(
	 ...
	 * @generated
	 */
	protected visGrid.Capacitor getOldSource() {
		return (visGrid.Capacitor) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Capacitor getNewSource() {
		return (visGrid.Capacitor) newEnd;
	}
