 ...
 * @generated
 */
public class MicrowaveConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MicrowaveConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Microwave) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Microwave)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMicrowaveConnection_4139(
	 ...
	 * @generated
	 */
	protected visGrid.Microwave getOldSource() {
		return (visGrid.Microwave) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Microwave getNewSource() {
		return (visGrid.Microwave) newEnd;
	}
