 ...
 * @generated
 */
public class RectifierConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RectifierConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof visGrid.Rectifier) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof visGrid.Connections && newEnd instanceof visGrid.Rectifier)) {
			return false;
		}
		return visGrid.diagram.edit.policies.VisGridBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRectifierConnection_4075(
	 ...
	 * @generated
	 */
	protected visGrid.Rectifier getOldSource() {
		return (visGrid.Rectifier) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected visGrid.Rectifier getNewSource() {
