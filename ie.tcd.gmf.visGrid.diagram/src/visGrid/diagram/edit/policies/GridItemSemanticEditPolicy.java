...
public class GridItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (visGrid.diagram.providers.VisGridElementTypes.Comm_2057 == req
				.getElementType()) {
			return getGEFWrapper(new visGrid.diagram.edit.commands.CommCreateCommand(
					req));
		}
		if (visGrid.diagram.providers.VisGridElementTypes.Solar_2058 == req
				.getElementType()) {
