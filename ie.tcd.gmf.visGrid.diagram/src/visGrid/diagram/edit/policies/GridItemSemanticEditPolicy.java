...
public class GridItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (visGrid.diagram.providers.VisGridElementTypes.Series_reactor_2041 == req
				.getElementType()) {
		...
		if (visGrid.diagram.providers.VisGridElementTypes.Load_2043 == req
				.getElementType()) {
		...
		if (visGrid.diagram.providers.VisGridElementTypes.Histogram_2073 == req
				.getElementType()) {
			return getGEFWrapper(new visGrid.diagram.edit.commands.HistogramCreateCommand(
					req));
		}
		if (visGrid.diagram.providers.VisGridElementTypes.Shaper_2074 == req
				.getElementType()) {
			return getGEFWrapper(new visGrid.diagram.edit.commands.ShaperCreateCommand(
					req));
		}
		if (visGrid.diagram.providers.VisGridElementTypes.Generator_2075 == req
				.getElementType()) {
			return getGEFWrapper(new visGrid.diagram.edit.commands.GeneratorCreateCommand(
					req));
		}
		if (visGrid.diagram.providers.VisGridElementTypes.Triplex_line_configuration_2076 == req
				.getElementType()) {
			return getGEFWrapper(new visGrid.diagram.edit.commands.Triplex_line_configurationCreateCommand(
					req));
		}
		if (visGrid.diagram.providers.VisGridElementTypes.Connections_2077 == req
				.getElementType()) {
			return getGEFWrapper(new visGrid.diagram.edit.commands.ConnectionsCreateCommand(
					req));
		}
		if (visGrid.diagram.providers.VisGridElementTypes.Motor_2078 == req
				.getElementType()) {
			return getGEFWrapper(new visGrid.diagram.edit.commands.MotorCreateCommand(
					req));
		}
		if (visGrid.diagram.providers.VisGridElementTypes.Diesel_dg_2079 == req
				.getElementType()) {
