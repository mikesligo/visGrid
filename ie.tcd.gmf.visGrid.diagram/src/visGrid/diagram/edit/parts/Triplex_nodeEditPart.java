...
public class Triplex_nodeEditPart extends ShapeNodeEditPart {
	...
	public class Triplex_nodeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			triplex_nodeFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(triplex_nodeFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutTriplex_nodeFigureSVG1 = new BorderLayout();
			triplex_nodeFigureSVG1
					.setLayoutManager(layoutTriplex_nodeFigureSVG1);
