...
public class EvchargerEditPart extends ShapeNodeEditPart {
	...
	public class EvchargerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			evchargerFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(evchargerFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutEvchargerFigureSVG1 = new BorderLayout();
			evchargerFigureSVG1.setLayoutManager(layoutEvchargerFigureSVG1);
