...
public class EvchargerEditPart extends ShapeNodeEditPart {
	...
	public class EvchargerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(innerSVG0, new Rectangle(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0), getMapMode().DPtoLP(150),
			...
			innerSVG0.add(evchargerFigureSVG1, new Rectangle(0, 0, getMapMode()
					.DPtoLP(150), getMapMode().DPtoLP(80)));
			...
			this.add(
					...
					new Rectangle(getMapMode().DPtoLP(0), getMapMode().DPtoLP(
							80), getMapMode().DPtoLP(150), getMapMode().DPtoLP(
							60)));
