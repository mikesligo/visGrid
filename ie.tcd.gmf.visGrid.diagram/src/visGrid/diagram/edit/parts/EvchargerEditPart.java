...
public class EvchargerEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof visGrid.diagram.edit.parts.EvchargerStateEditPart) {
			((visGrid.diagram.edit.parts.EvchargerStateEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureEvchargerStateFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.EvchargerChargeEditPart) {
			((visGrid.diagram.edit.parts.EvchargerChargeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureEvchargerChargeFigure());
			return true;
		}
		return false;
	}
	...
	public class EvchargerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(innerSVG0, new Rectangle(getMapMode().DPtoLP(15),
					getMapMode().DPtoLP(0), getMapMode().DPtoLP(120),
					getMapMode().DPtoLP(64)));
			innerSVG0.setLayoutManager(new XYLayout());

			SVGFigure evchargerFigureSVG1 = new SVGFigure();
         File tempFile = new File("visGridImages/evcharger.svg");
		evchargerFigureSVG1.setURI(tempFile.toURI().toString());
			...
			this.add(
					...
					new Rectangle(getMapMode().DPtoLP(0), getMapMode().DPtoLP(
							64), getMapMode().DPtoLP(150), getMapMode().DPtoLP(
							60)));
			...
			inner0.add(fFigureEvchargerNameFigure);

			FlowLayout layoutFFigureEvchargerNameFigure = new FlowLayout();
			layoutFFigureEvchargerNameFigure.setStretchMinorAxis(false);
			layoutFFigureEvchargerNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureEvchargerNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureEvchargerNameFigure.setMajorSpacing(5);
			layoutFFigureEvchargerNameFigure.setMinorSpacing(5);
			layoutFFigureEvchargerNameFigure.setHorizontal(true);

			fFigureEvchargerNameFigure
					.setLayoutManager(layoutFFigureEvchargerNameFigure);

			fFigureEvchargerStateFigure = new WrappingLabel();
			fFigureEvchargerStateFigure.setText("<...>");

			inner0.add(fFigureEvchargerStateFigure);

			FlowLayout layoutFFigureEvchargerStateFigure = new FlowLayout();
			layoutFFigureEvchargerStateFigure.setStretchMinorAxis(false);
			layoutFFigureEvchargerStateFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureEvchargerStateFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureEvchargerStateFigure.setMajorSpacing(5);
			layoutFFigureEvchargerStateFigure.setMinorSpacing(5);
			layoutFFigureEvchargerStateFigure.setHorizontal(true);

			fFigureEvchargerStateFigure
					.setLayoutManager(layoutFFigureEvchargerStateFigure);

			fFigureEvchargerChargeFigure = new WrappingLabel();
			fFigureEvchargerChargeFigure.setText("<...>");

			inner0.add(fFigureEvchargerChargeFigure);

			FlowLayout layoutFFigureEvchargerChargeFigure = new FlowLayout();
			layoutFFigureEvchargerChargeFigure.setStretchMinorAxis(false);
			layoutFFigureEvchargerChargeFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureEvchargerChargeFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureEvchargerChargeFigure.setMajorSpacing(5);
			layoutFFigureEvchargerChargeFigure.setMinorSpacing(5);
			layoutFFigureEvchargerChargeFigure.setHorizontal(true);

			fFigureEvchargerChargeFigure
					.setLayoutManager(layoutFFigureEvchargerChargeFigure);
