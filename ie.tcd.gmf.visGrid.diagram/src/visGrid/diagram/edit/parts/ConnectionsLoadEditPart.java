 ...
 * @generated
 */
public class ConnectionsLoadEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4140;

	/**
	 * @generated
	 */
	public ConnectionsLoadEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.ConnectionsLoadItemSemanticEditPolicy());
	}
