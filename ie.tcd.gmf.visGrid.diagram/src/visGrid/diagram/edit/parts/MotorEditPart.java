...
public class MotorEditPart extends ShapeNodeEditPart {
	...
	public class MotorFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			motorFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/motor.svg");
			motorFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(motorFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutMotorFigureSVG1 = new BorderLayout();
			motorFigureSVG1.setLayoutManager(layoutMotorFigureSVG1);
			...
			inner0.add(fFigureMotorNameFigure);

			FlowLayout layoutFFigureMotorNameFigure = new FlowLayout();
			layoutFFigureMotorNameFigure.setStretchMinorAxis(false);
			layoutFFigureMotorNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureMotorNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureMotorNameFigure.setMajorSpacing(5);
			layoutFFigureMotorNameFigure.setMinorSpacing(5);
			layoutFFigureMotorNameFigure.setHorizontal(true);

			fFigureMotorNameFigure
					.setLayoutManager(layoutFFigureMotorNameFigure);
