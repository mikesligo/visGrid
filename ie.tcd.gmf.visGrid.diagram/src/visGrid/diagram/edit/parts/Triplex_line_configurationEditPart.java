...
public class Triplex_line_configurationEditPart extends ShapeNodeEditPart {
	...
	public class Triplex_line_configurationFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure triplex_line_configurationFigureSVG1 = new SVGFigure();
			triplex_line_configurationFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/triplex_line_configuration.svg");
			triplex_line_configurationFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(triplex_line_configurationFigureSVG1,
					BorderLayout.CENTER);

			BorderLayout layoutTriplex_line_configurationFigureSVG1 = new BorderLayout();
			triplex_line_configurationFigureSVG1
					.setLayoutManager(layoutTriplex_line_configurationFigureSVG1);
			...
			inner0.add(fFigureTriplex_line_configurationNameFigure);

			FlowLayout layoutFFigureTriplex_line_configurationNameFigure = new FlowLayout();
			layoutFFigureTriplex_line_configurationNameFigure
			...
			fFigureTriplex_line_configurationNameFigure
					.setLayoutManager(layoutFFigureTriplex_line_configurationNameFigure);
