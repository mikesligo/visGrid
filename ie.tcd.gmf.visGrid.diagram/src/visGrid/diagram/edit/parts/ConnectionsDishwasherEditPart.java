 ...
 * @generated
 */
public class ConnectionsDishwasherEditPart extends ConnectionNodeEditPart
		implements ITreeBranchEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4146;

	/**
	 * @generated
	 */
	public ConnectionsDishwasherEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.ConnectionsDishwasherItemSemanticEditPolicy());
	}
