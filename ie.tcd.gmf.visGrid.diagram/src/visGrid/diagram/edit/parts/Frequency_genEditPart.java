	...
	public class Frequency_genFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			frequency_genFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/frequency_gen.svg");
			frequency_genFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(frequency_genFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutFrequency_genFigureSVG1 = new BorderLayout();
			frequency_genFigureSVG1
					.setLayoutManager(layoutFrequency_genFigureSVG1);
			...
			inner0.add(fFigureFrequency_genNameFigure);

			FlowLayout layoutFFigureFrequency_genNameFigure = new FlowLayout();
			layoutFFigureFrequency_genNameFigure.setStretchMinorAxis(false);
			layoutFFigureFrequency_genNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureFrequency_genNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureFrequency_genNameFigure.setMajorSpacing(5);
			layoutFFigureFrequency_genNameFigure.setMinorSpacing(5);
			layoutFFigureFrequency_genNameFigure.setHorizontal(true);

			fFigureFrequency_genNameFigure
					.setLayoutManager(layoutFFigureFrequency_genNameFigure);
