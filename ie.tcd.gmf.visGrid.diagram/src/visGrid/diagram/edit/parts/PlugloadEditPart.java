...
public class PlugloadEditPart extends ShapeNodeEditPart {
	...
	public class PlugloadFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure plugloadFigureSVG1 = new SVGFigure();
			plugloadFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/plugload.svg");
			plugloadFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(plugloadFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutPlugloadFigureSVG1 = new BorderLayout();
			plugloadFigureSVG1.setLayoutManager(layoutPlugloadFigureSVG1);
			...
			inner0.add(fFigurePlugloadNameFigure);

			FlowLayout layoutFFigurePlugloadNameFigure = new FlowLayout();
			layoutFFigurePlugloadNameFigure.setStretchMinorAxis(false);
			layoutFFigurePlugloadNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigurePlugloadNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigurePlugloadNameFigure.setMajorSpacing(5);
			layoutFFigurePlugloadNameFigure.setMinorSpacing(5);
			layoutFFigurePlugloadNameFigure.setHorizontal(true);

			fFigurePlugloadNameFigure
					.setLayoutManager(layoutFFigurePlugloadNameFigure);
