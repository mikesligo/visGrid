...
public class MultizoneEditPart extends ShapeNodeEditPart {
	...
	public class MultizoneFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			multizoneFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/multizone.svg");
			multizoneFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(multizoneFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutMultizoneFigureSVG1 = new BorderLayout();
			multizoneFigureSVG1.setLayoutManager(layoutMultizoneFigureSVG1);
			...
			inner0.add(fFigureMultizoneNameFigure);

			FlowLayout layoutFFigureMultizoneNameFigure = new FlowLayout();
			layoutFFigureMultizoneNameFigure.setStretchMinorAxis(false);
			layoutFFigureMultizoneNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureMultizoneNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureMultizoneNameFigure.setMajorSpacing(5);
			layoutFFigureMultizoneNameFigure.setMinorSpacing(5);
			layoutFFigureMultizoneNameFigure.setHorizontal(true);

			fFigureMultizoneNameFigure
					.setLayoutManager(layoutFFigureMultizoneNameFigure);
