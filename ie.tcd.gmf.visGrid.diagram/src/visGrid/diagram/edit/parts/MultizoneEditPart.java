...
public class MultizoneEditPart extends ShapeNodeEditPart {
	...
	public class MultizoneFigure extends RectangleFigure {
		...
		multizoneFigureSVG1.setURI(org.apache.commons.io.FilenameUtils.separatorsToSystem(new String("file://"+tempFile.getAbsolutePath() +"\\visGridImages\\multizone.svg")));
