...
public class SwitchEditPart extends ShapeNodeEditPart {
	...
	public class SwitchFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			switchFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/switch.svg");
			switchFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(switchFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutSwitchFigureSVG1 = new BorderLayout();
			switchFigureSVG1.setLayoutManager(layoutSwitchFigureSVG1);
			...
			inner0.add(fFigureSwitchNameFigure);

			FlowLayout layoutFFigureSwitchNameFigure = new FlowLayout();
			layoutFFigureSwitchNameFigure.setStretchMinorAxis(false);
			layoutFFigureSwitchNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureSwitchNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureSwitchNameFigure.setMajorSpacing(5);
			layoutFFigureSwitchNameFigure.setMinorSpacing(5);
			layoutFFigureSwitchNameFigure.setHorizontal(true);

			fFigureSwitchNameFigure
					.setLayoutManager(layoutFFigureSwitchNameFigure);
