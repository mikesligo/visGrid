...
public class LineEditPart extends ShapeNodeEditPart {
	...
	public class LineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			lineFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/line.svg");
			lineFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(lineFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutLineFigureSVG1 = new BorderLayout();
			lineFigureSVG1.setLayoutManager(layoutLineFigureSVG1);
			...
			inner0.add(fFigureLineNameFigure);

			FlowLayout layoutFFigureLineNameFigure = new FlowLayout();
			layoutFFigureLineNameFigure.setStretchMinorAxis(false);
			layoutFFigureLineNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureLineNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureLineNameFigure.setMajorSpacing(5);
			layoutFFigureLineNameFigure.setMinorSpacing(5);
			layoutFFigureLineNameFigure.setHorizontal(true);

			fFigureLineNameFigure.setLayoutManager(layoutFFigureLineNameFigure);
