 ...
 * @generated
 */
public class Fault_checkEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Fault_checkEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.Fault_checkItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Fault_checkFigure();
	}

	/**
	 * @generated
	 */
	public Fault_checkFigure getPrimaryShape() {
		return (Fault_checkFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof visGrid.diagram.edit.parts.Fault_checkNameEditPart) {
			((visGrid.diagram.edit.parts.Fault_checkNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureFault_checkNameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class Fault_checkFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureFault_checkNameFigure;

		/**
		 * @generated
		 */
		public Fault_checkFigure() {
		...
		private void createContents() {
			...
			fault_checkFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(fault_checkFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutFault_checkFigureSVG1 = new BorderLayout();
			fault_checkFigureSVG1.setLayoutManager(layoutFault_checkFigureSVG1);
			...
			fFigureFault_checkNameFigure = new WrappingLabel();
			fFigureFault_checkNameFigure.setText("<...>");

			inner0.add(fFigureFault_checkNameFigure);

			FlowLayout layoutFFigureFault_checkNameFigure = new FlowLayout();
			layoutFFigureFault_checkNameFigure.setStretchMinorAxis(false);
			layoutFFigureFault_checkNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureFault_checkNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureFault_checkNameFigure.setMajorSpacing(5);
			layoutFFigureFault_checkNameFigure.setMinorSpacing(5);
			layoutFFigureFault_checkNameFigure.setHorizontal(true);

			fFigureFault_checkNameFigure
					.setLayoutManager(layoutFFigureFault_checkNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFault_checkNameFigure() {
			return fFigureFault_checkNameFigure;
		}
