...
public class MicrowaveEditPart extends ShapeNodeEditPart {
	...
	public class MicrowaveFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			microwaveFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(microwaveFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutMicrowaveFigureSVG1 = new BorderLayout();
			microwaveFigureSVG1.setLayoutManager(layoutMicrowaveFigureSVG1);
			...
			inner0.add(fFigureMicrowaveNameFigure);

			FlowLayout layoutFFigureMicrowaveNameFigure = new FlowLayout();
			layoutFFigureMicrowaveNameFigure.setStretchMinorAxis(false);
			layoutFFigureMicrowaveNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureMicrowaveNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureMicrowaveNameFigure.setMajorSpacing(5);
			layoutFFigureMicrowaveNameFigure.setMinorSpacing(5);
			layoutFFigureMicrowaveNameFigure.setHorizontal(true);

			fFigureMicrowaveNameFigure
					.setLayoutManager(layoutFFigureMicrowaveNameFigure);
