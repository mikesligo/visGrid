...
public class CollectorEditPart extends ShapeNodeEditPart {
	...
	public class CollectorFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			collectorFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/collector.svg");
			collectorFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(collectorFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutCollectorFigureSVG1 = new BorderLayout();
			collectorFigureSVG1.setLayoutManager(layoutCollectorFigureSVG1);
			...
			inner0.add(fFigureCollectorNameFigure);

			FlowLayout layoutFFigureCollectorNameFigure = new FlowLayout();
			layoutFFigureCollectorNameFigure.setStretchMinorAxis(false);
			layoutFFigureCollectorNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureCollectorNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureCollectorNameFigure.setMajorSpacing(5);
			layoutFFigureCollectorNameFigure.setMinorSpacing(5);
			layoutFFigureCollectorNameFigure.setHorizontal(true);

			fFigureCollectorNameFigure
					.setLayoutManager(layoutFFigureCollectorNameFigure);
