	...
	public class Transformer_configurationFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			transformer_configurationFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/transformer_configuration.svg");
			transformer_configurationFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(transformer_configurationFigureSVG1,
					BorderLayout.CENTER);

			BorderLayout layoutTransformer_configurationFigureSVG1 = new BorderLayout();
			transformer_configurationFigureSVG1
					.setLayoutManager(layoutTransformer_configurationFigureSVG1);
			...
			inner0.add(fFigureTransformer_configurationNameFigure);

			FlowLayout layoutFFigureTransformer_configurationNameFigure = new FlowLayout();
			layoutFFigureTransformer_configurationNameFigure
			...
			layoutFFigureTransformer_configurationNameFigure.setMajorSpacing(5);
			layoutFFigureTransformer_configurationNameFigure.setMinorSpacing(5);
			layoutFFigureTransformer_configurationNameFigure
					.setHorizontal(true);

			fFigureTransformer_configurationNameFigure
					.setLayoutManager(layoutFFigureTransformer_configurationNameFigure);
