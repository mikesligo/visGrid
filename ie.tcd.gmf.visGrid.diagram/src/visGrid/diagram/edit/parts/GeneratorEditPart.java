...
public class GeneratorEditPart extends ShapeNodeEditPart {
	...
	public class GeneratorFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			generatorFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/generator.svg");
			generatorFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(generatorFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutGeneratorFigureSVG1 = new BorderLayout();
			generatorFigureSVG1.setLayoutManager(layoutGeneratorFigureSVG1);
			...
			inner0.add(fFigureGeneratorNameFigure);

			FlowLayout layoutFFigureGeneratorNameFigure = new FlowLayout();
			layoutFFigureGeneratorNameFigure.setStretchMinorAxis(false);
			layoutFFigureGeneratorNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureGeneratorNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureGeneratorNameFigure.setMajorSpacing(5);
			layoutFFigureGeneratorNameFigure.setMinorSpacing(5);
			layoutFFigureGeneratorNameFigure.setHorizontal(true);

			fFigureGeneratorNameFigure
					.setLayoutManager(layoutFFigureGeneratorNameFigure);
