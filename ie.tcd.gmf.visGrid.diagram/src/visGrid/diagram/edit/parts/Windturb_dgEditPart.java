	...
	public class Windturb_dgFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			windturb_dgFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/windturb_dg.svg");
			windturb_dgFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(windturb_dgFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutWindturb_dgFigureSVG1 = new BorderLayout();
			windturb_dgFigureSVG1.setLayoutManager(layoutWindturb_dgFigureSVG1);
			...
			inner0.add(fFigureWindturb_dgNameFigure);

			FlowLayout layoutFFigureWindturb_dgNameFigure = new FlowLayout();
			layoutFFigureWindturb_dgNameFigure.setStretchMinorAxis(false);
			layoutFFigureWindturb_dgNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureWindturb_dgNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureWindturb_dgNameFigure.setMajorSpacing(5);
			layoutFFigureWindturb_dgNameFigure.setMinorSpacing(5);
			layoutFFigureWindturb_dgNameFigure.setHorizontal(true);

			fFigureWindturb_dgNameFigure
					.setLayoutManager(layoutFFigureWindturb_dgNameFigure);
