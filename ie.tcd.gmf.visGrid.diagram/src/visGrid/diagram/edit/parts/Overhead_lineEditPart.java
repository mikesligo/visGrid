...
public class Overhead_lineEditPart extends ShapeNodeEditPart {
	...
	public class Overhead_lineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			overhead_lineFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(overhead_lineFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutOverhead_lineFigureSVG1 = new BorderLayout();
			overhead_lineFigureSVG1
					.setLayoutManager(layoutOverhead_lineFigureSVG1);
