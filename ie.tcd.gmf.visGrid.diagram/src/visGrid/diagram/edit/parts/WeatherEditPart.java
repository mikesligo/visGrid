...
public class WeatherEditPart extends ShapeNodeEditPart {
	...
	public class WeatherFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			weatherFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/weather.svg");
			weatherFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(weatherFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutWeatherFigureSVG1 = new BorderLayout();
			weatherFigureSVG1.setLayoutManager(layoutWeatherFigureSVG1);
			...
			inner0.add(fFigureWeatherNameFigure);

			FlowLayout layoutFFigureWeatherNameFigure = new FlowLayout();
			layoutFFigureWeatherNameFigure.setStretchMinorAxis(false);
			layoutFFigureWeatherNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureWeatherNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureWeatherNameFigure.setMajorSpacing(5);
			layoutFFigureWeatherNameFigure.setMinorSpacing(5);
			layoutFFigureWeatherNameFigure.setHorizontal(true);

			fFigureWeatherNameFigure
					.setLayoutManager(layoutFFigureWeatherNameFigure);
