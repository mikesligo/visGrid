...
public class ClimateEditPart extends ShapeNodeEditPart {
	...
	public class ClimateFigure extends RectangleFigure {
		...
		climateFigureSVG1.setURI(org.apache.commons.io.FilenameUtils.separatorsToSystem(new String("file://"+tempFile.getAbsolutePath() +"\\visGridImages\\climate.svg")));

			innerSVG0.add(climateFigureSVG1, new Rectangle(0, 0, getMapMode()
			...
			inner0.add(fFigureClimateNameFigure);

			FlowLayout layoutFFigureClimateNameFigure = new FlowLayout();
			layoutFFigureClimateNameFigure.setStretchMinorAxis(false);
			layoutFFigureClimateNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureClimateNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureClimateNameFigure.setMajorSpacing(5);
			layoutFFigureClimateNameFigure.setMinorSpacing(5);
			layoutFFigureClimateNameFigure.setHorizontal(true);

			fFigureClimateNameFigure
					.setLayoutManager(layoutFFigureClimateNameFigure);
