...
public class PlayerEditPart extends ShapeNodeEditPart {
	...
	public class PlayerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			playerFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/player.svg");
			playerFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(playerFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutPlayerFigureSVG1 = new BorderLayout();
			playerFigureSVG1.setLayoutManager(layoutPlayerFigureSVG1);
			...
			inner0.add(fFigurePlayerNameFigure);

			FlowLayout layoutFFigurePlayerNameFigure = new FlowLayout();
			layoutFFigurePlayerNameFigure.setStretchMinorAxis(false);
			layoutFFigurePlayerNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigurePlayerNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigurePlayerNameFigure.setMajorSpacing(5);
			layoutFFigurePlayerNameFigure.setMinorSpacing(5);
			layoutFFigurePlayerNameFigure.setHorizontal(true);

			fFigurePlayerNameFigure
					.setLayoutManager(layoutFFigurePlayerNameFigure);
