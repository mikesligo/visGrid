 ...
 * @generated
 */
public class ConnectionsDryerEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4094;

	/**
	 * @generated
	 */
	public ConnectionsDryerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.ConnectionsDryerItemSemanticEditPolicy());
	}
