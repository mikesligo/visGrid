...
public class CommEditPart extends ShapeNodeEditPart {
	...
	public class CommFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			commFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(commFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutCommFigureSVG1 = new BorderLayout();
			commFigureSVG1.setLayoutManager(layoutCommFigureSVG1);
			...
			inner0.add(fFigureCommNameFigure);

			FlowLayout layoutFFigureCommNameFigure = new FlowLayout();
			layoutFFigureCommNameFigure.setStretchMinorAxis(false);
			layoutFFigureCommNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureCommNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureCommNameFigure.setMajorSpacing(5);
			layoutFFigureCommNameFigure.setMinorSpacing(5);
			layoutFFigureCommNameFigure.setHorizontal(true);

			fFigureCommNameFigure.setLayoutManager(layoutFFigureCommNameFigure);
