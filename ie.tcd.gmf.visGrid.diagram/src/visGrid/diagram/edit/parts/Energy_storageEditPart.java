	...
	public class Energy_storageFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			energy_storageFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/energy_storage.svg");
			energy_storageFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(energy_storageFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutEnergy_storageFigureSVG1 = new BorderLayout();
			energy_storageFigureSVG1
					.setLayoutManager(layoutEnergy_storageFigureSVG1);
			...
			inner0.add(fFigureEnergy_storageNameFigure);

			FlowLayout layoutFFigureEnergy_storageNameFigure = new FlowLayout();
			layoutFFigureEnergy_storageNameFigure.setStretchMinorAxis(false);
			layoutFFigureEnergy_storageNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureEnergy_storageNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureEnergy_storageNameFigure.setMajorSpacing(5);
			layoutFFigureEnergy_storageNameFigure.setMinorSpacing(5);
			layoutFFigureEnergy_storageNameFigure.setHorizontal(true);

			fFigureEnergy_storageNameFigure
					.setLayoutManager(layoutFFigureEnergy_storageNameFigure);
