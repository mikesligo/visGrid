...
public class FreezerEditPart extends ShapeNodeEditPart {
	...
	public class FreezerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			freezerFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/freezer.svg");
			freezerFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(freezerFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutFreezerFigureSVG1 = new BorderLayout();
			freezerFigureSVG1.setLayoutManager(layoutFreezerFigureSVG1);
			...
			inner0.add(fFigureFreezerNameFigure);

			FlowLayout layoutFFigureFreezerNameFigure = new FlowLayout();
			layoutFFigureFreezerNameFigure.setStretchMinorAxis(false);
			layoutFFigureFreezerNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureFreezerNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureFreezerNameFigure.setMajorSpacing(5);
			layoutFFigureFreezerNameFigure.setMinorSpacing(5);
			layoutFFigureFreezerNameFigure.setHorizontal(true);

			fFigureFreezerNameFigure
					.setLayoutManager(layoutFFigureFreezerNameFigure);
