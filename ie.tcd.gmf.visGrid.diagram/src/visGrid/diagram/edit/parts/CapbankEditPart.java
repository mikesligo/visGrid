...
public class CapbankEditPart extends ShapeNodeEditPart {
	...
	public class CapbankFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			capbankFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/capbank.svg");
			capbankFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(capbankFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutCapbankFigureSVG1 = new BorderLayout();
			capbankFigureSVG1.setLayoutManager(layoutCapbankFigureSVG1);
			...
			inner0.add(fFigureCapbankNameFigure);

			FlowLayout layoutFFigureCapbankNameFigure = new FlowLayout();
			layoutFFigureCapbankNameFigure.setStretchMinorAxis(false);
			layoutFFigureCapbankNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureCapbankNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureCapbankNameFigure.setMajorSpacing(5);
			layoutFFigureCapbankNameFigure.setMinorSpacing(5);
			layoutFFigureCapbankNameFigure.setHorizontal(true);

			fFigureCapbankNameFigure
					.setLayoutManager(layoutFFigureCapbankNameFigure);
