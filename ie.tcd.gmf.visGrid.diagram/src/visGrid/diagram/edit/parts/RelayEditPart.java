...
public class RelayEditPart extends ShapeNodeEditPart {
	...
	public class RelayFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure relayFigureSVG1 = new SVGFigure();
			relayFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/relay.svg");
			relayFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(relayFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutRelayFigureSVG1 = new BorderLayout();
			relayFigureSVG1.setLayoutManager(layoutRelayFigureSVG1);
			...
			inner0.add(fFigureRelayNameFigure);

			FlowLayout layoutFFigureRelayNameFigure = new FlowLayout();
			layoutFFigureRelayNameFigure.setStretchMinorAxis(false);
			layoutFFigureRelayNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureRelayNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureRelayNameFigure.setMajorSpacing(5);
			layoutFFigureRelayNameFigure.setMinorSpacing(5);
			layoutFFigureRelayNameFigure.setHorizontal(true);

			fFigureRelayNameFigure
					.setLayoutManager(layoutFFigureRelayNameFigure);
