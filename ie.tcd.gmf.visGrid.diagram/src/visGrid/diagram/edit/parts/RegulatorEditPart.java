...
public class RegulatorEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof visGrid.diagram.edit.parts.RegulatorName2EditPart) {
			((visGrid.diagram.edit.parts.RegulatorName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRegulator_configurationNameFigure());
			return true;
		}
		return false;
	}
	...
	public class Regulator_configurationFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure regulator_configurationFigureSVG1 = new SVGFigure();
			regulator_configurationFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/regulator_configuration.svg");
			regulator_configurationFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(regulator_configurationFigureSVG1,
					BorderLayout.CENTER);

			BorderLayout layoutRegulator_configurationFigureSVG1 = new BorderLayout();
			regulator_configurationFigureSVG1
					.setLayoutManager(layoutRegulator_configurationFigureSVG1);
			...
			inner0.add(fFigureRegulator_configurationNameFigure);

			FlowLayout layoutFFigureRegulator_configurationNameFigure = new FlowLayout();
			layoutFFigureRegulator_configurationNameFigure
			...
			layoutFFigureRegulator_configurationNameFigure.setMajorSpacing(5);
			layoutFFigureRegulator_configurationNameFigure.setMinorSpacing(5);
			layoutFFigureRegulator_configurationNameFigure.setHorizontal(true);

			fFigureRegulator_configurationNameFigure
					.setLayoutManager(layoutFFigureRegulator_configurationNameFigure);
