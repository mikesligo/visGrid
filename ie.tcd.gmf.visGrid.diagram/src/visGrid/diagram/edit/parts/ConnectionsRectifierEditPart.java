 ...
 * @generated
 */
public class ConnectionsRectifierEditPart extends ConnectionNodeEditPart
		implements ITreeBranchEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4108;

	/**
	 * @generated
	 */
	public ConnectionsRectifierEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.ConnectionsRectifierItemSemanticEditPolicy());
	}
