 ...
 * @generated
 */
public class BilldumpEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public BilldumpEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.BilldumpItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new BilldumpFigure();
	}

	/**
	 * @generated
	 */
	public BilldumpFigure getPrimaryShape() {
		return (BilldumpFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof visGrid.diagram.edit.parts.BilldumpNameEditPart) {
			((visGrid.diagram.edit.parts.BilldumpNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureBilldumpNameFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.BilldumpFilenameEditPart) {
			((visGrid.diagram.edit.parts.BilldumpFilenameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureBilldumpFilenameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class BilldumpFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureBilldumpNameFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureBilldumpFilenameFigure;

		/**
		 * @generated
		 */
		public BilldumpFigure() {
		...
		private void createContents() {
			...
			billdumpFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/billdump.svg");
			billdumpFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(billdumpFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutBilldumpFigureSVG1 = new BorderLayout();
			billdumpFigureSVG1.setLayoutManager(layoutBilldumpFigureSVG1);
			...
			fFigureBilldumpNameFigure = new WrappingLabel();
			fFigureBilldumpNameFigure.setText("<...>");

			inner0.add(fFigureBilldumpNameFigure);

			FlowLayout layoutFFigureBilldumpNameFigure = new FlowLayout();
			layoutFFigureBilldumpNameFigure.setStretchMinorAxis(false);
			layoutFFigureBilldumpNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureBilldumpNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureBilldumpNameFigure.setMajorSpacing(5);
			layoutFFigureBilldumpNameFigure.setMinorSpacing(5);
			layoutFFigureBilldumpNameFigure.setHorizontal(true);

			fFigureBilldumpNameFigure
					.setLayoutManager(layoutFFigureBilldumpNameFigure);

			fFigureBilldumpFilenameFigure = new WrappingLabel();
			fFigureBilldumpFilenameFigure.setText("<...>");

			inner0.add(fFigureBilldumpFilenameFigure);

			FlowLayout layoutFFigureBilldumpFilenameFigure = new FlowLayout();
			layoutFFigureBilldumpFilenameFigure.setStretchMinorAxis(false);
			layoutFFigureBilldumpFilenameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureBilldumpFilenameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureBilldumpFilenameFigure.setMajorSpacing(5);
			layoutFFigureBilldumpFilenameFigure.setMinorSpacing(5);
			layoutFFigureBilldumpFilenameFigure.setHorizontal(true);

			fFigureBilldumpFilenameFigure
					.setLayoutManager(layoutFFigureBilldumpFilenameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureBilldumpNameFigure() {
			return fFigureBilldumpNameFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureBilldumpFilenameFigure() {
			return fFigureBilldumpFilenameFigure;
		}
