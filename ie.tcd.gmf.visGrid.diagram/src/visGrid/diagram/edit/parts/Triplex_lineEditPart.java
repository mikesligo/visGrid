...
public class Triplex_lineEditPart extends ShapeNodeEditPart {
	...
	public class Triplex_lineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			triplex_lineFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(triplex_lineFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutTriplex_lineFigureSVG1 = new BorderLayout();
			triplex_lineFigureSVG1
					.setLayoutManager(layoutTriplex_lineFigureSVG1);
