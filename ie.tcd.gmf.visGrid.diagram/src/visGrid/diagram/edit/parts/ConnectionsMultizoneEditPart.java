 ...
 * @generated
 */
public class ConnectionsMultizoneEditPart extends ConnectionNodeEditPart
		implements ITreeBranchEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4100;

	/**
	 * @generated
	 */
	public ConnectionsMultizoneEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.ConnectionsMultizoneItemSemanticEditPolicy());
	}
