	...
	public class Power_electronicsFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			power_electronicsFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/power_electronics.svg");
			power_electronicsFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(power_electronicsFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutPower_electronicsFigureSVG1 = new BorderLayout();
			power_electronicsFigureSVG1
					.setLayoutManager(layoutPower_electronicsFigureSVG1);
			...
			inner0.add(fFigurePower_electronicsNameFigure);

			FlowLayout layoutFFigurePower_electronicsNameFigure = new FlowLayout();
			layoutFFigurePower_electronicsNameFigure.setStretchMinorAxis(false);
			layoutFFigurePower_electronicsNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigurePower_electronicsNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigurePower_electronicsNameFigure.setMajorSpacing(5);
			layoutFFigurePower_electronicsNameFigure.setMinorSpacing(5);
			layoutFFigurePower_electronicsNameFigure.setHorizontal(true);

			fFigurePower_electronicsNameFigure
					.setLayoutManager(layoutFFigurePower_electronicsNameFigure);
