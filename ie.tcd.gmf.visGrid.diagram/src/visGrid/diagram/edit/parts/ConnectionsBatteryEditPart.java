 ...
 * @generated
 */
public class ConnectionsBatteryEditPart extends ConnectionNodeEditPart
		implements ITreeBranchEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4148;

	/**
	 * @generated
	 */
	public ConnectionsBatteryEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.ConnectionsBatteryItemSemanticEditPolicy());
	}
