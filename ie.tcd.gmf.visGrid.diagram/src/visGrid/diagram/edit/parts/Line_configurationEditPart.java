...
public class Line_configurationEditPart extends ShapeNodeEditPart {
	...
	public class Line_configurationFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			SVGFigure line_configurationFigureSVG1 = new SVGFigure();
			line_configurationFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/line_configuration.svg");
			line_configurationFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(line_configurationFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutLine_configurationFigureSVG1 = new BorderLayout();
			line_configurationFigureSVG1
					.setLayoutManager(layoutLine_configurationFigureSVG1);
			...
			inner0.add(fFigureLine_configurationNameFigure);

			FlowLayout layoutFFigureLine_configurationNameFigure = new FlowLayout();
			layoutFFigureLine_configurationNameFigure
			...
			layoutFFigureLine_configurationNameFigure.setMajorSpacing(5);
			layoutFFigureLine_configurationNameFigure.setMinorSpacing(5);
			layoutFFigureLine_configurationNameFigure.setHorizontal(true);

			fFigureLine_configurationNameFigure
					.setLayoutManager(layoutFFigureLine_configurationNameFigure);
