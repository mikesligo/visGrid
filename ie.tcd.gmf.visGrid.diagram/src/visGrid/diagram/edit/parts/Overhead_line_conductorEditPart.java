	...
	public class Overhead_line_conductorFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			overhead_line_conductorFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/overhead_line_conductor.svg");
			overhead_line_conductorFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(overhead_line_conductorFigureSVG1,
					BorderLayout.CENTER);

			BorderLayout layoutOverhead_line_conductorFigureSVG1 = new BorderLayout();
			overhead_line_conductorFigureSVG1
					.setLayoutManager(layoutOverhead_line_conductorFigureSVG1);
			...
			inner0.add(fFigureOverhead_line_conductorNameFigure);

			FlowLayout layoutFFigureOverhead_line_conductorNameFigure = new FlowLayout();
			layoutFFigureOverhead_line_conductorNameFigure
			...
			layoutFFigureOverhead_line_conductorNameFigure.setMajorSpacing(5);
			layoutFFigureOverhead_line_conductorNameFigure.setMinorSpacing(5);
			layoutFFigureOverhead_line_conductorNameFigure.setHorizontal(true);

			fFigureOverhead_line_conductorNameFigure
					.setLayoutManager(layoutFFigureOverhead_line_conductorNameFigure);
