...
public class Diesel_dgEditPart extends ShapeNodeEditPart {
	...
	public class Diesel_dgFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			diesel_dgFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/diesel_dg.svg");
			diesel_dgFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(diesel_dgFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutDiesel_dgFigureSVG1 = new BorderLayout();
			diesel_dgFigureSVG1.setLayoutManager(layoutDiesel_dgFigureSVG1);
			...
			inner0.add(fFigureDiesel_dgNameFigure);

			FlowLayout layoutFFigureDiesel_dgNameFigure = new FlowLayout();
			layoutFFigureDiesel_dgNameFigure.setStretchMinorAxis(false);
			layoutFFigureDiesel_dgNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureDiesel_dgNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureDiesel_dgNameFigure.setMajorSpacing(5);
			layoutFFigureDiesel_dgNameFigure.setMinorSpacing(5);
			layoutFFigureDiesel_dgNameFigure.setHorizontal(true);

			fFigureDiesel_dgNameFigure
					.setLayoutManager(layoutFFigureDiesel_dgNameFigure);
