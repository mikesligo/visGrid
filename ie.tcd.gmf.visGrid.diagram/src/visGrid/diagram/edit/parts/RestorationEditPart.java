 ...
 * @generated
 */
public class RestorationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RestorationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.RestorationItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new RestorationFigure();
	}

	/**
	 * @generated
	 */
	public RestorationFigure getPrimaryShape() {
		return (RestorationFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof visGrid.diagram.edit.parts.RestorationNameEditPart) {
			((visGrid.diagram.edit.parts.RestorationNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRestorationNameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class RestorationFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureRestorationNameFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureRestorationConfiguration_fileFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureRestorationReconfig_attemptsFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureRestorationReconfig_iteration_limitFigure;

		/**
		 * @generated
		 */
		public RestorationFigure() {
		...
		private void createContents() {
			...
			fFigureRestorationNameFigure = new WrappingLabel();
			fFigureRestorationNameFigure.setText("<...>");

			this.add(fFigureRestorationNameFigure);

			fFigureRestorationConfiguration_fileFigure = new WrappingLabel();
			fFigureRestorationConfiguration_fileFigure.setText("<...>");

			this.add(fFigureRestorationConfiguration_fileFigure);

			fFigureRestorationReconfig_attemptsFigure = new WrappingLabel();
			fFigureRestorationReconfig_attemptsFigure.setText("<...>");

			this.add(fFigureRestorationReconfig_attemptsFigure);

			fFigureRestorationReconfig_iteration_limitFigure = new WrappingLabel();
			fFigureRestorationReconfig_iteration_limitFigure.setText("<...>");

			this.add(fFigureRestorationReconfig_iteration_limitFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRestorationNameFigure() {
			return fFigureRestorationNameFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureRestorationConfiguration_fileFigure() {
			return fFigureRestorationConfiguration_fileFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureRestorationReconfig_attemptsFigure() {
			return fFigureRestorationReconfig_attemptsFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureRestorationReconfig_iteration_limitFigure() {
			return fFigureRestorationReconfig_iteration_limitFigure;
		}
