 ...
 * @generated
 */
public class ConnectionsWeatherEditPart extends ConnectionNodeEditPart
		implements ITreeBranchEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4145;

	/**
	 * @generated
	 */
	public ConnectionsWeatherEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new visGrid.diagram.edit.policies.ConnectionsWeatherItemSemanticEditPolicy());
	}
