...
public class HouseEditPart extends ShapeNodeEditPart {
	...
	public class HouseFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			houseFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(houseFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutHouseFigureSVG1 = new BorderLayout();
			houseFigureSVG1.setLayoutManager(layoutHouseFigureSVG1);
