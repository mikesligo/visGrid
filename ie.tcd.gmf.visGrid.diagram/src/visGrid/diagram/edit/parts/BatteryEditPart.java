...
public class BatteryEditPart extends ShapeNodeEditPart {
	...
	public class BatteryFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			batteryFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/battery.svg");
			batteryFigureSVG1.setMinimumSize(new Dimension(getMapMode().DPtoLP(
					60), getMapMode().DPtoLP(60)));

			innerSVG0.add(batteryFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutBatteryFigureSVG1 = new BorderLayout();
			batteryFigureSVG1.setLayoutManager(layoutBatteryFigureSVG1);
			...
			inner0.add(fFigureBatteryNameFigure);

			FlowLayout layoutFFigureBatteryNameFigure = new FlowLayout();
			layoutFFigureBatteryNameFigure.setStretchMinorAxis(false);
			layoutFFigureBatteryNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureBatteryNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureBatteryNameFigure.setMajorSpacing(5);
			layoutFFigureBatteryNameFigure.setMinorSpacing(5);
			layoutFFigureBatteryNameFigure.setHorizontal(true);

			fFigureBatteryNameFigure
					.setLayoutManager(layoutFFigureBatteryNameFigure);
