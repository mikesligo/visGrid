...
public class ControllerEditPart extends ShapeNodeEditPart {
	...
	public class ControllerFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			controllerFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/controller.svg");
			controllerFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(controllerFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutControllerFigureSVG1 = new BorderLayout();
			controllerFigureSVG1.setLayoutManager(layoutControllerFigureSVG1);
			...
			inner0.add(fFigureControllerNameFigure);

			FlowLayout layoutFFigureControllerNameFigure = new FlowLayout();
			layoutFFigureControllerNameFigure.setStretchMinorAxis(false);
			layoutFFigureControllerNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureControllerNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureControllerNameFigure.setMajorSpacing(5);
			layoutFFigureControllerNameFigure.setMinorSpacing(5);
			layoutFFigureControllerNameFigure.setHorizontal(true);

			fFigureControllerNameFigure
					.setLayoutManager(layoutFFigureControllerNameFigure);
