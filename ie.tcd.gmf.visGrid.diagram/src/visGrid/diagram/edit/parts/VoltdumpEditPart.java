...
public class VoltdumpEditPart extends ShapeNodeEditPart {
	...
	public class VoltdumpFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			voltdumpFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(voltdumpFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutVoltdumpFigureSVG1 = new BorderLayout();
			voltdumpFigureSVG1.setLayoutManager(layoutVoltdumpFigureSVG1);
			...
			inner0.add(fFigureVoltdumpNameFigure, BorderLayout.TOP);

			fFigureVoltdumpFilenameFigure = new WrappingLabel();
			fFigureVoltdumpFilenameFigure.setText("<...>");

			inner0.add(fFigureVoltdumpFilenameFigure, BorderLayout.TOP);
