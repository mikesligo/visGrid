...
public class FuseEditPart extends ShapeNodeEditPart {
	...
	public class FuseFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fuseFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(fuseFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutFuseFigureSVG1 = new BorderLayout();
			fuseFigureSVG1.setLayoutManager(layoutFuseFigureSVG1);
			...
			inner0.add(fFigureFuseNameFigure);

			FlowLayout layoutFFigureFuseNameFigure = new FlowLayout();
			layoutFFigureFuseNameFigure.setStretchMinorAxis(false);
			layoutFFigureFuseNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureFuseNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureFuseNameFigure.setMajorSpacing(5);
			layoutFFigureFuseNameFigure.setMinorSpacing(5);
			layoutFFigureFuseNameFigure.setHorizontal(true);

			fFigureFuseNameFigure.setLayoutManager(layoutFFigureFuseNameFigure);
