	...
	public class OccupantloadFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			occupantloadFigureSVG1
					.setURI("file:///home/mike/src/visGrid/ie.tcd.gmf.visGrid/images/occupantload.svg");
			occupantloadFigureSVG1.setMinimumSize(new Dimension(getMapMode()
					.DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(occupantloadFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutOccupantloadFigureSVG1 = new BorderLayout();
			occupantloadFigureSVG1
					.setLayoutManager(layoutOccupantloadFigureSVG1);
			...
			inner0.add(fFigureOccupantloadNameFigure);

			FlowLayout layoutFFigureOccupantloadNameFigure = new FlowLayout();
			layoutFFigureOccupantloadNameFigure.setStretchMinorAxis(false);
			layoutFFigureOccupantloadNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureOccupantloadNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureOccupantloadNameFigure.setMajorSpacing(5);
			layoutFFigureOccupantloadNameFigure.setMinorSpacing(5);
			layoutFFigureOccupantloadNameFigure.setHorizontal(true);

			fFigureOccupantloadNameFigure
					.setLayoutManager(layoutFFigureOccupantloadNameFigure);
