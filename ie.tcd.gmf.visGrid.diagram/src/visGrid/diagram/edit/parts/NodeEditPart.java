...
public class NodeEditPart extends ShapeNodeEditPart {
	...
	public class NodeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			nodeFigureSVG1.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(60), getMapMode().DPtoLP(60)));

			innerSVG0.add(nodeFigureSVG1, BorderLayout.CENTER);

			BorderLayout layoutNodeFigureSVG1 = new BorderLayout();
			nodeFigureSVG1.setLayoutManager(layoutNodeFigureSVG1);
