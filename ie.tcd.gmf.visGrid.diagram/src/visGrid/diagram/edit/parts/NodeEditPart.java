...
public class NodeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof visGrid.diagram.edit.parts.NodeVoltage_AEditPart) {
			((visGrid.diagram.edit.parts.NodeVoltage_AEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureNodeVoltage_AFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.NodeVoltage_BEditPart) {
			((visGrid.diagram.edit.parts.NodeVoltage_BEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureNodeVoltage_BFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.NodeVoltage_CEditPart) {
			((visGrid.diagram.edit.parts.NodeVoltage_CEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureNodeVoltage_CFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.NodeVoltage_ABEditPart) {
			((visGrid.diagram.edit.parts.NodeVoltage_ABEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureNodeVoltage_ABFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.NodeVoltage_BCEditPart) {
			((visGrid.diagram.edit.parts.NodeVoltage_BCEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureNodeVoltage_BCFigure());
			return true;
		}
		if (childEditPart instanceof visGrid.diagram.edit.parts.NodeVoltage_CAEditPart) {
			((visGrid.diagram.edit.parts.NodeVoltage_CAEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureNodeVoltage_CAFigure());
			return true;
		}
		return false;
	}
	...
	public class NodeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(innerSVG0, new Rectangle(getMapMode().DPtoLP(40),
			...
			this.add(
					...
					new Rectangle(getMapMode().DPtoLP(0), getMapMode().DPtoLP(
							60), getMapMode().DPtoLP(120), getMapMode().DPtoLP(
							60)));
			...
			inner0.add(fFigureNodeNameFigure);

			FlowLayout layoutFFigureNodeNameFigure = new FlowLayout();
			layoutFFigureNodeNameFigure.setStretchMinorAxis(false);
			layoutFFigureNodeNameFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureNodeNameFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureNodeNameFigure.setMajorSpacing(5);
			layoutFFigureNodeNameFigure.setMinorSpacing(5);
			layoutFFigureNodeNameFigure.setHorizontal(true);

			fFigureNodeNameFigure.setLayoutManager(layoutFFigureNodeNameFigure);

			fFigureNodeVoltage_AFigure = new WrappingLabel();
			fFigureNodeVoltage_AFigure.setText("<...>");

			inner0.add(fFigureNodeVoltage_AFigure);

			FlowLayout layoutFFigureNodeVoltage_AFigure = new FlowLayout();
			layoutFFigureNodeVoltage_AFigure.setStretchMinorAxis(false);
			layoutFFigureNodeVoltage_AFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureNodeVoltage_AFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureNodeVoltage_AFigure.setMajorSpacing(5);
			layoutFFigureNodeVoltage_AFigure.setMinorSpacing(5);
			layoutFFigureNodeVoltage_AFigure.setHorizontal(true);

			fFigureNodeVoltage_AFigure
					.setLayoutManager(layoutFFigureNodeVoltage_AFigure);

			fFigureNodeVoltage_BFigure = new WrappingLabel();
			fFigureNodeVoltage_BFigure.setText("<...>");

			inner0.add(fFigureNodeVoltage_BFigure);

			FlowLayout layoutFFigureNodeVoltage_BFigure = new FlowLayout();
			layoutFFigureNodeVoltage_BFigure.setStretchMinorAxis(false);
			layoutFFigureNodeVoltage_BFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureNodeVoltage_BFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureNodeVoltage_BFigure.setMajorSpacing(5);
			layoutFFigureNodeVoltage_BFigure.setMinorSpacing(5);
			layoutFFigureNodeVoltage_BFigure.setHorizontal(true);

			fFigureNodeVoltage_BFigure
					.setLayoutManager(layoutFFigureNodeVoltage_BFigure);

			fFigureNodeVoltage_CFigure = new WrappingLabel();
			fFigureNodeVoltage_CFigure.setText("<...>");

			inner0.add(fFigureNodeVoltage_CFigure);

			FlowLayout layoutFFigureNodeVoltage_CFigure = new FlowLayout();
			layoutFFigureNodeVoltage_CFigure.setStretchMinorAxis(false);
			layoutFFigureNodeVoltage_CFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureNodeVoltage_CFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureNodeVoltage_CFigure.setMajorSpacing(5);
			layoutFFigureNodeVoltage_CFigure.setMinorSpacing(5);
			layoutFFigureNodeVoltage_CFigure.setHorizontal(true);

			fFigureNodeVoltage_CFigure
					.setLayoutManager(layoutFFigureNodeVoltage_CFigure);

			fFigureNodeVoltage_ABFigure = new WrappingLabel();
			fFigureNodeVoltage_ABFigure.setText("<...>");

			inner0.add(fFigureNodeVoltage_ABFigure);

			FlowLayout layoutFFigureNodeVoltage_ABFigure = new FlowLayout();
			layoutFFigureNodeVoltage_ABFigure.setStretchMinorAxis(false);
			layoutFFigureNodeVoltage_ABFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureNodeVoltage_ABFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureNodeVoltage_ABFigure.setMajorSpacing(5);
			layoutFFigureNodeVoltage_ABFigure.setMinorSpacing(5);
			layoutFFigureNodeVoltage_ABFigure.setHorizontal(true);

			fFigureNodeVoltage_ABFigure
					.setLayoutManager(layoutFFigureNodeVoltage_ABFigure);

			fFigureNodeVoltage_BCFigure = new WrappingLabel();
			fFigureNodeVoltage_BCFigure.setText("<...>");

			inner0.add(fFigureNodeVoltage_BCFigure);

			FlowLayout layoutFFigureNodeVoltage_BCFigure = new FlowLayout();
			layoutFFigureNodeVoltage_BCFigure.setStretchMinorAxis(false);
			layoutFFigureNodeVoltage_BCFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureNodeVoltage_BCFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureNodeVoltage_BCFigure.setMajorSpacing(5);
			layoutFFigureNodeVoltage_BCFigure.setMinorSpacing(5);
			layoutFFigureNodeVoltage_BCFigure.setHorizontal(true);

			fFigureNodeVoltage_BCFigure
					.setLayoutManager(layoutFFigureNodeVoltage_BCFigure);

			fFigureNodeVoltage_CAFigure = new WrappingLabel();
			fFigureNodeVoltage_CAFigure.setText("<...>");

			inner0.add(fFigureNodeVoltage_CAFigure);

			FlowLayout layoutFFigureNodeVoltage_CAFigure = new FlowLayout();
			layoutFFigureNodeVoltage_CAFigure.setStretchMinorAxis(false);
			layoutFFigureNodeVoltage_CAFigure
					.setMinorAlignment(FlowLayout.ALIGN_LEFTTOP);

			layoutFFigureNodeVoltage_CAFigure
					.setMajorAlignment(FlowLayout.ALIGN_LEFTTOP);
			layoutFFigureNodeVoltage_CAFigure.setMajorSpacing(5);
			layoutFFigureNodeVoltage_CAFigure.setMinorSpacing(5);
			layoutFFigureNodeVoltage_CAFigure.setHorizontal(true);

			fFigureNodeVoltage_CAFigure
					.setLayoutManager(layoutFFigureNodeVoltage_CAFigure);
