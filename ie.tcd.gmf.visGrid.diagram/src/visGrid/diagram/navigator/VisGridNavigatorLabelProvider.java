...
public class VisGridNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case visGrid.diagram.edit.parts.TimeEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://tcd.ie?Time", visGrid.diagram.providers.VisGridElementTypes.Time_2082); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private String getTime_2082Text(View view) {
		IParser parser = visGrid.diagram.providers.VisGridParserProvider
				.getParser(
						visGrid.diagram.providers.VisGridElementTypes.Time_2082,
						view.getElement() != null ? view.getElement() : view,
						visGrid.diagram.part.VisGridVisualIDRegistry
		...
		if (parser != null) {
			...
			visGrid.diagram.part.VisGridDiagramEditorPlugin.getInstance()
					.logError("Parser was not found for label " + 5098); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
