 ...
 * @generated
 */
public class VisGridDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public VisGridDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof visGrid.diagram.navigator.VisGridDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((visGrid.diagram.navigator.VisGridDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new visGrid.diagram.navigator.VisGridDomainNavigatorItem(
