 ...
 * @generated
 */
public class SimpleGridDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof simpleGrid.diagram.navigator.SimpleGridDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((simpleGrid.diagram.navigator.SimpleGridDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new simpleGrid.diagram.navigator.SimpleGridDomainNavigatorItem(
