 ...
 * @generated
 */
public class SimpleGridCreationWizardPage extends WizardNewFileCreationPage {
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(NLS
					.bind(simpleGrid.diagram.part.Messages.SimpleGridCreationWizardPageExtensionError,
							extension));
			return false;
		}
		return true;
