 ...
 * @generated
 */
public class SimpleGridInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new simpleGrid.diagram.part.SimpleGridNewDiagramFileWizard(
		...
		simpleGrid.diagram.part.SimpleGridDiagramEditorUtil.runWizard(
