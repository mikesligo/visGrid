 ...
 * @generated
 */
public class TransformerTransformer_configurationCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public TransformerTransformer_configurationCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null
				&& false == target instanceof simpleGrid.Transformer_configuration) {
			return false;
		}
		if (getSource() == null) {
		...
		return simpleGrid.diagram.edit.policies.SimpleGridBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateTransformerTransformer_configuration_4006(
						getSource(), getTarget());
	}
