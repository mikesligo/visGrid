 ...
 * <ul>
 *   <li>{@link visGrid.Lights#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.Lights#getName <em>Name</em>}</li>
...
public interface Lights extends EObject {
	 ...
	 * @see visGrid.VisGridPackage#getLights_Connection()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see visGrid.VisGridPackage#getLights_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link visGrid.Lights#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
