 ...
 * <ul>
 *   <li>{@link visGrid.impl.OfficeImpl#getConnection <em>Connection</em>}</li>
...
public class OfficeImpl extends EObjectImpl implements Office {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.OFFICE__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.OFFICE__CONNECTION:
