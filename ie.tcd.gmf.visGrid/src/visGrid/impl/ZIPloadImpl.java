 ...
 * <ul>
 *   <li>{@link visGrid.impl.ZIPloadImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class ZIPloadImpl extends EObjectImpl implements ZIPload {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.ZI_PLOAD__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.ZI_PLOAD__CONNECTION:
