...
public class ZIPloadImpl extends ConnectionImpl implements ZIPload {
	...
	public String getHeat_fraction() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"heat_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Heat_fraction");
				heat_fraction= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getBase_power() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"base_power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Base_power");
				base_power= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getPower_pf() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"power_pf");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Power_pf");
				power_pf= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getCurrent_pf() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"current_pf");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Current_pf");
				current_pf= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getImpedance_pf() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"impedance_pf");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Impedance_pf");
				impedance_pf= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getIs_240() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"is_240");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Is_240");
				is_240= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getBreaker_val() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"breaker_val");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Breaker_val");
				breaker_val= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
