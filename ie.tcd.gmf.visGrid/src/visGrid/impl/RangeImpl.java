 ...
 * <ul>
 *   <li>{@link visGrid.impl.RangeImpl#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.impl.RangeImpl#getName <em>Name</em>}</li>
...
public class RangeImpl extends EObjectImpl implements Range {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.RANGE__CONNECTION);
		}
		return connection;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.RANGE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.RANGE__CONNECTION:
