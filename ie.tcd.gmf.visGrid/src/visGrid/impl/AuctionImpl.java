 ...
 * <ul>
 *   <li>{@link visGrid.impl.AuctionImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class AuctionImpl extends EObjectImpl implements Auction {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.AUCTION__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.AUCTION__CONNECTION:
