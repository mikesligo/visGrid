 ...
 * <ul>
 *   <li>{@link visGrid.impl.CollectorImpl#getConnection <em>Connection</em>}</li>
...
public class CollectorImpl extends EObjectImpl implements Collector {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.COLLECTOR__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.COLLECTOR__CONNECTION:
