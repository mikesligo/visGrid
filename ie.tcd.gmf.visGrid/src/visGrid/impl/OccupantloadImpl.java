...
public class OccupantloadImpl extends ConnectionImpl implements Occupantload {
   ...
   private void checkUnlock() {
	...
	public String getNumber_of_occupants() {
		// Generated by python script located in this directory
			if (!lock.containsKey("number_of_occupants")) lock.put("number_of_occupants", new Boolean(false));
			if (!(Boolean)lock.get("number_of_occupants")){
				lock.put("number_of_occupants", true);
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"number_of_occupants");
					if (val == null) val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"Number_of_occupants");
	...
	public String getOccupancy_fraction() {
		// Generated by python script located in this directory
			if (!lock.containsKey("occupancy_fraction")) lock.put("occupancy_fraction", new Boolean(false));
			if (!(Boolean)lock.get("occupancy_fraction")){
				lock.put("occupancy_fraction", true);
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"occupancy_fraction");
					if (val == null) val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"Occupancy_fraction");
	...
	public String getHeatgain_per_person() {
		// Generated by python script located in this directory
			if (!lock.containsKey("heatgain_per_person")) lock.put("heatgain_per_person", new Boolean(false));
			if (!(Boolean)lock.get("heatgain_per_person")){
				lock.put("heatgain_per_person", true);
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"heatgain_per_person");
					if (val == null) val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"Heatgain_per_person");
