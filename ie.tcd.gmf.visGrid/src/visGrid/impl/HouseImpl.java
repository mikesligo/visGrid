...
public class HouseImpl extends ConnectionImpl implements House {
	...
	public String getGross_wall_area() {
		...
		if (!lock){
			try {
				...
				this.setGross_wall_area("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getCeiling_height() {
		...
		if (!lock){
			try {
				...
				this.setCeiling_height("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getWindow_wall_ratio() {
		...
		if (!lock){
			try {
				...
				this.setWindow_wall_ratio("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getNumber_of_doors() {
		...
		if (!lock){
			try {
				...
				this.setNumber_of_doors("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getExterior_wall_fraction() {
		...
		if (!lock){
			try {
				...
				this.setExterior_wall_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getInterior_exterior_wall_ratio() {
		...
		if (!lock){
			try {
				...
				this.setInterior_exterior_wall_ratio("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getExterior_ceiling_fraction() {
		...
		if (!lock){
			try {
				...
				this.setExterior_ceiling_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getExterior_floor_fraction() {
		...
		if (!lock){
			try {
				...
				this.setExterior_floor_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getWindow_shading() {
		...
		if (!lock){
			try {
				...
				this.setWindow_shading("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getWindow_exterior_transmission_coefficient() {
		...
		if (!lock){
			try {
				...
				this.setWindow_exterior_transmission_coefficient("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getSolar_heatgain_factor() {
		...
		if (!lock){
			try {
				...
				this.setSolar_heatgain_factor("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAirchange_per_hour() {
		...
		if (!lock){
			try {
				...
				this.setAirchange_per_hour("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHeat_cool_gain() {
		...
		if (!lock){
			try {
				...
				this.setHeat_cool_gain("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getThermostat_deadband() {
		...
		if (!lock){
			try {
				...
				this.setThermostat_deadband("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getThermostat_cycle_time() {
		...
		if (!lock){
			try {
				...
				this.setThermostat_cycle_time("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getThermostat_last_cycle_time() {
		...
		if (!lock){
			try {
				...
				this.setThermostat_last_cycle_time("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHeating_setpoint() {
		...
		if (!lock){
			try {
				...
				this.setHeating_setpoint("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getCooling_setpoint() {
		...
		if (!lock){
			try {
				...
				this.setCooling_setpoint("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDesign_heating_setpoint() {
		...
		if (!lock){
			try {
				...
				this.setDesign_heating_setpoint("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDesign_cooling_setpoint() {
		...
		if (!lock){
			try {
				...
				this.setDesign_cooling_setpoint("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDesign_heating_capacity() {
		...
		if (!lock){
			try {
				...
				this.setDesign_heating_capacity("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDesign_cooling_capacity() {
		...
		if (!lock){
			try {
				...
				this.setDesign_cooling_capacity("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAdj_heating_cap() {
		...
		if (!lock){
			try {
				...
				this.setAdj_heating_cap("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getCooling_design_temperature() {
		...
		if (!lock){
			try {
				...
				this.setCooling_design_temperature("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHeating_design_temperature() {
		...
		if (!lock){
			try {
				...
				this.setHeating_design_temperature("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDesign_peak_solar() {
		...
		if (!lock){
			try {
				...
				this.setDesign_peak_solar("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDesign_internal_gains() {
		...
		if (!lock){
			try {
				...
				this.setDesign_internal_gains("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAir_heat_fraction() {
		...
		if (!lock){
			try {
				...
				this.setAir_heat_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAuxiliary_heat_capacity() {
		...
		if (!lock){
			try {
				...
				this.setAuxiliary_heat_capacity("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAux_heat_deadband() {
		...
		if (!lock){
			try {
				...
				this.setAux_heat_deadband("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAux_heat_temperature_lockout() {
		...
		if (!lock){
			try {
				...
				this.setAux_heat_temperature_lockout("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAux_heat_time_delay() {
		...
		if (!lock){
			try {
				...
				this.setAux_heat_time_delay("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getCooling_supply_air_temp() {
		...
		if (!lock){
			try {
				...
				this.setCooling_supply_air_temp("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHeating_supply_air_temp() {
		...
		if (!lock){
			try {
				...
				this.setHeating_supply_air_temp("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDuct_pressure_drop() {
		...
		if (!lock){
			try {
				...
				this.setDuct_pressure_drop("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getFan_design_power() {
		...
		if (!lock){
			try {
				...
				this.setFan_design_power("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getFan_low_power_fraction() {
		...
		if (!lock){
			try {
				...
				this.setFan_low_power_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getFan_design_airflow() {
		...
		if (!lock){
			try {
				...
				this.setFan_design_airflow("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getFan_impedance_fraction() {
		...
		if (!lock){
			try {
				...
				this.setFan_impedance_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getFan_power_fraction() {
		...
		if (!lock){
			try {
				...
				this.setFan_power_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getFan_current_fraction() {
		...
		if (!lock){
			try {
				...
				this.setFan_current_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getFan_power_factor() {
		...
		if (!lock){
			try {
				...
				this.setFan_power_factor("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHeating_demand() {
		...
		if (!lock){
			try {
				...
				this.setHeating_demand("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getCooling_demand() {
		...
		if (!lock){
			try {
				...
				this.setCooling_demand("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAdj_heating_cop() {
		...
		if (!lock){
			try {
				...
				this.setAdj_heating_cop("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAir_temperature() {
		...
		if (!lock){
			try {
				...
				this.setAir_temperature("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getOutdoor_temperature() {
		...
		if (!lock){
			try {
				...
				this.setOutdoor_temperature("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getMass_heat_capacity() {
		...
		if (!lock){
			try {
				...
				this.setMass_heat_capacity("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getMass_heat_coeff() {
		...
		if (!lock){
			try {
				...
				this.setMass_heat_coeff("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getMass_temperature() {
		...
		if (!lock){
			try {
				...
				this.setMass_temperature("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAir_heat_capacity() {
		...
		if (!lock){
			try {
				...
				this.setAir_heat_capacity("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getLatent_load_fraction() {
		...
		if (!lock){
			try {
				...
				this.setLatent_load_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getTotal_thermal_mass_per_floor_area() {
		...
		if (!lock){
			try {
				...
				this.setTotal_thermal_mass_per_floor_area("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getInterior_surface_heat_transfer_coeff() {
		...
		if (!lock){
			try {
				...
				this.setInterior_surface_heat_transfer_coeff("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getNumber_of_stories() {
		...
		if (!lock){
			try {
				...
				this.setNumber_of_stories("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAuxiliary_strategy() {
		...
		if (!lock){
			try {
				...
				this.setAuxiliary_strategy("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHeating_system_type() {
		...
		if (!lock){
			try {
				...
				this.setHeating_system_type("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getCooling_system_type() {
		...
		if (!lock){
			try {
				...
				this.setCooling_system_type("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getAuxiliary_system_type() {
		...
		if (!lock){
			try {
				...
				this.setAuxiliary_system_type("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getThermal_integrity_level() {
		...
		if (!lock){
			try {
				...
				this.setThermal_integrity_level("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getGlazing_treatment() {
		...
		if (!lock){
			try {
				...
				this.setGlazing_treatment("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getGlazing_layers() {
		...
		if (!lock){
			try {
				...
				this.setGlazing_layers("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getMotor_efficiency() {
		...
		if (!lock){
			try {
				...
				this.setMotor_efficiency("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHvac_motor_efficiency() {
		...
		if (!lock){
			try {
				...
				this.setHvac_motor_efficiency("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHvac_motor_loss_power_factor() {
		...
		if (!lock){
			try {
				...
				this.setHvac_motor_loss_power_factor("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHvac_breaker_rating() {
		...
		if (!lock){
			try {
				...
				this.setHvac_breaker_rating("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHvac_power_factor() {
		...
		if (!lock){
			try {
				...
				this.setHvac_power_factor("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__energy() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__energy");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__energy");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20energy");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20energy");
				panel__energy= val;
			} catch (Exception e) {
				this.setPanel__energy("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__power() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20power");
				panel__power= val;
			} catch (Exception e) {
				this.setPanel__power("unknown");
				e.printStackTrace();
			}
		}
		return panel__power;
	...
	public String getPanel__peak_demand() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__peak_demand");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__peak_demand");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20peak_demand");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20peak_demand");
				panel__peak_demand= val;
			} catch (Exception e) {
				this.setPanel__peak_demand("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__heatgain() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__heatgain");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__heatgain");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20heatgain");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20heatgain");
				panel__heatgain= val;
			} catch (Exception e) {
				this.setPanel__heatgain("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__heatgain_fraction() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__heatgain_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__heatgain_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20heatgain_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20heatgain_fraction");
				panel__heatgain_fraction= val;
			} catch (Exception e) {
				this.setPanel__heatgain_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__current_fraction() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__current_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__current_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20current_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20current_fraction");
				panel__current_fraction= val;
			} catch (Exception e) {
				this.setPanel__current_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__impedance_fraction() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__impedance_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__impedance_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20impedance_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20impedance_fraction");
				panel__impedance_fraction= val;
			} catch (Exception e) {
				this.setPanel__impedance_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__power_fraction() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__power_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__power_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20power_fraction");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20power_fraction");
				panel__power_fraction= val;
			} catch (Exception e) {
				this.setPanel__power_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__power_factor() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__power_factor");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__power_factor");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20power_factor");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20power_factor");
				panel__power_factor= val;
			} catch (Exception e) {
				this.setPanel__power_factor("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__constant_power() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__constant_power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__constant_power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20constant_power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20constant_power");
				panel__constant_power= val;
			} catch (Exception e) {
				this.setPanel__constant_power("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__constant_current() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__constant_current");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__constant_current");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20constant_current");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20constant_current");
				panel__constant_current= val;
			} catch (Exception e) {
				this.setPanel__constant_current("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__constant_admittance() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__constant_admittance");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__constant_admittance");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20constant_admittance");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20constant_admittance");
				panel__constant_admittance= val;
			} catch (Exception e) {
				this.setPanel__constant_admittance("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__voltage_factor() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__voltage_factor");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__voltage_factor");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20voltage_factor");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20voltage_factor");
				panel__voltage_factor= val;
			} catch (Exception e) {
				this.setPanel__voltage_factor("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPanel__configuration() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"panel__configuration");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel__configuration");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"panel%20configuration");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Panel%20configuration");
				panel__configuration= val;
			} catch (Exception e) {
				this.setPanel__configuration("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getDesign_internal_gain_density() {
		...
		if (!lock){
			try {
				...
				this.setDesign_internal_gain_density("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getHeatgain_fraction() {
		...
		if (!lock){
			try {
				...
				this.setHeatgain_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getCurrent_fraction() {
		...
		if (!lock){
			try {
				...
				this.setCurrent_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getImpedance_fraction() {
		...
		if (!lock){
			try {
				...
				this.setImpedance_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getPower_fraction() {
		...
		if (!lock){
			try {
				...
				this.setPower_fraction("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getConstant_power() {
		...
		if (!lock){
			try {
				...
				this.setConstant_power("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getConstant_current() {
		...
		if (!lock){
			try {
				...
				this.setConstant_current("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getConstant_admittance() {
		...
		if (!lock){
			try {
				...
				this.setConstant_admittance("unknown");
				e.printStackTrace();
			}
		}
	...
	public String getVoltage_factor() {
		...
		if (!lock){
			try {
				...
				this.setVoltage_factor("unknown");
				e.printStackTrace();
			}
		}
