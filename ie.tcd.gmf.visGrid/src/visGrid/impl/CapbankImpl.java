...
public class CapbankImpl extends ConnectionImpl implements Capbank {
   ...
   private void checkUnlock() {
	...
	public String getKVARrated() {
		// Generated by python script located in this directory
		if (!lock.containsKey("kvaRrated")) lock.put("kvaRrated", new Boolean(false));
	...
	public String getVrated() {
		// Generated by python script located in this directory
		if (!lock.containsKey("vrated")) lock.put("vrated", new Boolean(false));
	...
	public String getPTnode() {
		// Generated by python script located in this directory
		if (!lock.containsKey("pTnode")) lock.put("pTnode", new Boolean(false));
	...
	public String getVARopen() {
		// Generated by python script located in this directory
		if (!lock.containsKey("vaRopen")) lock.put("vaRopen", new Boolean(false));
	...
	public String getVARclose() {
		// Generated by python script located in this directory
		if (!lock.containsKey("vaRclose")) lock.put("vaRclose", new Boolean(false));
	...
	public String getVopen() {
		// Generated by python script located in this directory
		if (!lock.containsKey("vopen")) lock.put("vopen", new Boolean(false));
	...
	public String getVclose() {
		// Generated by python script located in this directory
		if (!lock.containsKey("vclose")) lock.put("vclose", new Boolean(false));
