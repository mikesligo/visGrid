 ...
 * <ul>
 *   <li>{@link visGrid.impl.FreezerImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class FreezerImpl extends EObjectImpl implements Freezer {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.FREEZER__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.FREEZER__CONNECTION:
