 ...
 * <ul>
 *   <li>{@link visGrid.impl.Residential_enduseImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class Residential_enduseImpl extends EObjectImpl implements Residential_enduse {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.RESIDENTIAL_ENDUSE__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.RESIDENTIAL_ENDUSE__CONNECTION:
