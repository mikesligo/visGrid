 ...
 * <ul>
 *   <li>{@link visGrid.impl.PlugloadImpl#getConnection <em>Connection</em>}</li>
 *   <li>{@link visGrid.impl.PlugloadImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class PlugloadImpl extends EObjectImpl implements Plugload {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.PLUGLOAD__CONNECTION);
		}
		return connection;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisGridPackage.PLUGLOAD__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.PLUGLOAD__CONNECTION:
