 ...
 * <ul>
 *   <li>{@link visGrid.impl.CommImpl#getConnection <em>Connection</em>}</li>
...
public class CommImpl extends EObjectImpl implements Comm {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.COMM__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.COMM__CONNECTION:
