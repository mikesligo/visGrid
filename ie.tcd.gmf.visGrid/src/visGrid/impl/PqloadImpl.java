	...
	public String getT_nominal() {
		...
		if (!lock.containsKey("t_nominal")) lock.put("t_nominal", new Boolean(false));
			if (!(Boolean)lock.get("t_nominal")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"t_nominal");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"T_nominal");
					t_nominal= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZp_T() {
		...
		if (!lock.containsKey("zp_T")) lock.put("zp_T", new Boolean(false));
			if (!(Boolean)lock.get("zp_T")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zp_T");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zp_T");
					zp_T= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZp_H() {
		...
		if (!lock.containsKey("zp_H")) lock.put("zp_H", new Boolean(false));
			if (!(Boolean)lock.get("zp_H")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zp_H");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zp_H");
					zp_H= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZp_S() {
		...
		if (!lock.containsKey("zp_S")) lock.put("zp_S", new Boolean(false));
			if (!(Boolean)lock.get("zp_S")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zp_S");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zp_S");
					zp_S= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZp_W() {
		...
		if (!lock.containsKey("zp_W")) lock.put("zp_W", new Boolean(false));
			if (!(Boolean)lock.get("zp_W")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zp_W");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zp_W");
					zp_W= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZp_R() {
		...
		if (!lock.containsKey("zp_R")) lock.put("zp_R", new Boolean(false));
			if (!(Boolean)lock.get("zp_R")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zp_R");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zp_R");
					zp_R= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZp() {
		...
		if (!lock.containsKey("zp")) lock.put("zp", new Boolean(false));
			if (!(Boolean)lock.get("zp")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zp");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zp");
					zp= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZq_T() {
		...
		if (!lock.containsKey("zq_T")) lock.put("zq_T", new Boolean(false));
			if (!(Boolean)lock.get("zq_T")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zq_T");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zq_T");
					zq_T= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZq_H() {
		...
		if (!lock.containsKey("zq_H")) lock.put("zq_H", new Boolean(false));
			if (!(Boolean)lock.get("zq_H")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zq_H");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zq_H");
					zq_H= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZq_S() {
		...
		if (!lock.containsKey("zq_S")) lock.put("zq_S", new Boolean(false));
			if (!(Boolean)lock.get("zq_S")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zq_S");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zq_S");
					zq_S= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZq_W() {
		...
		if (!lock.containsKey("zq_W")) lock.put("zq_W", new Boolean(false));
			if (!(Boolean)lock.get("zq_W")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zq_W");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zq_W");
					zq_W= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZq_R() {
		...
		if (!lock.containsKey("zq_R")) lock.put("zq_R", new Boolean(false));
			if (!(Boolean)lock.get("zq_R")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zq_R");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zq_R");
					zq_R= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getZq() {
		...
		if (!lock.containsKey("zq")) lock.put("zq", new Boolean(false));
			if (!(Boolean)lock.get("zq")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"zq");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Zq");
					zq= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIm_T() {
		...
		if (!lock.containsKey("im_T")) lock.put("im_T", new Boolean(false));
			if (!(Boolean)lock.get("im_T")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"im_T");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Im_T");
					im_T= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIm_H() {
		...
		if (!lock.containsKey("im_H")) lock.put("im_H", new Boolean(false));
			if (!(Boolean)lock.get("im_H")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"im_H");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Im_H");
					im_H= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIm_S() {
		...
		if (!lock.containsKey("im_S")) lock.put("im_S", new Boolean(false));
			if (!(Boolean)lock.get("im_S")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"im_S");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Im_S");
					im_S= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIm_W() {
		...
		if (!lock.containsKey("im_W")) lock.put("im_W", new Boolean(false));
			if (!(Boolean)lock.get("im_W")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"im_W");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Im_W");
					im_W= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIm_R() {
		...
		if (!lock.containsKey("im_R")) lock.put("im_R", new Boolean(false));
			if (!(Boolean)lock.get("im_R")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"im_R");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Im_R");
					im_R= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIm() {
		...
		if (!lock.containsKey("im")) lock.put("im", new Boolean(false));
			if (!(Boolean)lock.get("im")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"im");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Im");
					im= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIa_T() {
		...
		if (!lock.containsKey("ia_T")) lock.put("ia_T", new Boolean(false));
			if (!(Boolean)lock.get("ia_T")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"ia_T");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Ia_T");
					ia_T= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIa_H() {
		...
		if (!lock.containsKey("ia_H")) lock.put("ia_H", new Boolean(false));
			if (!(Boolean)lock.get("ia_H")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"ia_H");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Ia_H");
					ia_H= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIa_S() {
		...
		if (!lock.containsKey("ia_S")) lock.put("ia_S", new Boolean(false));
			if (!(Boolean)lock.get("ia_S")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"ia_S");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Ia_S");
					ia_S= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIa_W() {
		...
		if (!lock.containsKey("ia_W")) lock.put("ia_W", new Boolean(false));
			if (!(Boolean)lock.get("ia_W")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"ia_W");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Ia_W");
					ia_W= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIa_R() {
		...
		if (!lock.containsKey("ia_R")) lock.put("ia_R", new Boolean(false));
			if (!(Boolean)lock.get("ia_R")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"ia_R");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Ia_R");
					ia_R= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getIa() {
		...
		if (!lock.containsKey("ia")) lock.put("ia", new Boolean(false));
			if (!(Boolean)lock.get("ia")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"ia");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Ia");
					ia= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPp_T() {
		...
		if (!lock.containsKey("pp_T")) lock.put("pp_T", new Boolean(false));
			if (!(Boolean)lock.get("pp_T")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pp_T");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pp_T");
					pp_T= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPp_H() {
		...
		if (!lock.containsKey("pp_H")) lock.put("pp_H", new Boolean(false));
			if (!(Boolean)lock.get("pp_H")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pp_H");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pp_H");
					pp_H= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPp_S() {
		...
		if (!lock.containsKey("pp_S")) lock.put("pp_S", new Boolean(false));
			if (!(Boolean)lock.get("pp_S")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pp_S");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pp_S");
					pp_S= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPp_W() {
		...
		if (!lock.containsKey("pp_W")) lock.put("pp_W", new Boolean(false));
			if (!(Boolean)lock.get("pp_W")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pp_W");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pp_W");
					pp_W= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPp_R() {
		...
		if (!lock.containsKey("pp_R")) lock.put("pp_R", new Boolean(false));
			if (!(Boolean)lock.get("pp_R")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pp_R");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pp_R");
					pp_R= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPp() {
		...
		if (!lock.containsKey("pp")) lock.put("pp", new Boolean(false));
			if (!(Boolean)lock.get("pp")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pp");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pp");
					pp= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPq_T() {
		...
		if (!lock.containsKey("pq_T")) lock.put("pq_T", new Boolean(false));
			if (!(Boolean)lock.get("pq_T")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pq_T");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pq_T");
					pq_T= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPq_H() {
		...
		if (!lock.containsKey("pq_H")) lock.put("pq_H", new Boolean(false));
			if (!(Boolean)lock.get("pq_H")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pq_H");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pq_H");
					pq_H= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPq_S() {
		...
		if (!lock.containsKey("pq_S")) lock.put("pq_S", new Boolean(false));
			if (!(Boolean)lock.get("pq_S")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pq_S");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pq_S");
					pq_S= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPq_W() {
		...
		if (!lock.containsKey("pq_W")) lock.put("pq_W", new Boolean(false));
			if (!(Boolean)lock.get("pq_W")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pq_W");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pq_W");
					pq_W= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPq_R() {
		...
		if (!lock.containsKey("pq_R")) lock.put("pq_R", new Boolean(false));
			if (!(Boolean)lock.get("pq_R")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pq_R");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pq_R");
					pq_R= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getPq() {
		...
		if (!lock.containsKey("pq")) lock.put("pq", new Boolean(false));
			if (!(Boolean)lock.get("pq")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"pq");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Pq");
					pq= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getInput_temp() {
		...
		if (!lock.containsKey("input_temp")) lock.put("input_temp", new Boolean(false));
			if (!(Boolean)lock.get("input_temp")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"input_temp");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Input_temp");
					input_temp= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getInput_humid() {
		...
		if (!lock.containsKey("input_humid")) lock.put("input_humid", new Boolean(false));
			if (!(Boolean)lock.get("input_humid")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"input_humid");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Input_humid");
					input_humid= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getInput_solar() {
		...
		if (!lock.containsKey("input_solar")) lock.put("input_solar", new Boolean(false));
			if (!(Boolean)lock.get("input_solar")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"input_solar");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Input_solar");
					input_solar= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getInput_wind() {
		...
		if (!lock.containsKey("input_wind")) lock.put("input_wind", new Boolean(false));
			if (!(Boolean)lock.get("input_wind")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"input_wind");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Input_wind");
					input_wind= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getInput_rain() {
		...
		if (!lock.containsKey("input_rain")) lock.put("input_rain", new Boolean(false));
			if (!(Boolean)lock.get("input_rain")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"input_rain");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Input_rain");
					input_rain= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getOutput_imped_p() {
		...
		if (!lock.containsKey("output_imped_p")) lock.put("output_imped_p", new Boolean(false));
			if (!(Boolean)lock.get("output_imped_p")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_imped_p");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_imped_p");
					output_imped_p= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getOutput_imped_q() {
		...
		if (!lock.containsKey("output_imped_q")) lock.put("output_imped_q", new Boolean(false));
			if (!(Boolean)lock.get("output_imped_q")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_imped_q");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_imped_q");
					output_imped_q= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getOutput_current_m() {
		...
		if (!lock.containsKey("output_current_m")) lock.put("output_current_m", new Boolean(false));
			if (!(Boolean)lock.get("output_current_m")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_current_m");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_current_m");
	...
	public String getOutput_current_a() {
		...
		if (!lock.containsKey("output_current_a")) lock.put("output_current_a", new Boolean(false));
			if (!(Boolean)lock.get("output_current_a")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_current_a");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_current_a");
	...
	public String getOutput_power_p() {
		...
		if (!lock.containsKey("output_power_p")) lock.put("output_power_p", new Boolean(false));
			if (!(Boolean)lock.get("output_power_p")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_power_p");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_power_p");
					output_power_p= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getOutput_power_q() {
		...
		if (!lock.containsKey("output_power_q")) lock.put("output_power_q", new Boolean(false));
			if (!(Boolean)lock.get("output_power_q")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_power_q");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_power_q");
					output_power_q= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getOutput_impedance() {
		...
		if (!lock.containsKey("output_impedance")) lock.put("output_impedance", new Boolean(false));
			if (!(Boolean)lock.get("output_impedance")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_impedance");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_impedance");
	...
	public String getOutput_current() {
		...
		if (!lock.containsKey("output_current")) lock.put("output_current", new Boolean(false));
			if (!(Boolean)lock.get("output_current")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_current");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_current");
					output_current= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String getOutput_power() {
		...
		if (!lock.containsKey("output_power")) lock.put("output_power", new Boolean(false));
			if (!(Boolean)lock.get("output_power")){
				...
				checkUnlock();
				try {
					String val = http.Property.getValueOfProperty(this.getName(),"output_power");
					if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Output_power");
					output_power= val;
				} catch (Exception e) {
					e.printStackTrace();
				}
