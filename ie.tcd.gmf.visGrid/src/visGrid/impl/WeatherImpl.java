 ...
 * <ul>
 *   <li>{@link visGrid.impl.WeatherImpl#getConnection <em>Connection</em>}</li>
 ...
 * @generated
 */
public class WeatherImpl extends EObjectImpl implements Weather {
	/**
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.WEATHER__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.WEATHER__CONNECTION:
