 ...
 * <ul>
 *   <li>{@link visGrid.impl.Windturb_dgImpl#getConnection <em>Connection</em>}</li>
...
public class Windturb_dgImpl extends EObjectImpl implements Windturb_dg {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.WINDTURB_DG__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.WINDTURB_DG__CONNECTION:
