...
public class DryerImpl extends ConnectionImpl implements Dryer {
   ...
   private void checkUnlock() {
	...
	public String getMotor_power() {
		// Generated by python script located in this directory
			if (!lock.containsKey("motor_power")) lock.put("motor_power", new Boolean(false));
			if (!(Boolean)lock.get("motor_power")){
	...
	public String getCoil_power() {
		// Generated by python script located in this directory
			if (!lock.containsKey("coil_power")) lock.put("coil_power", new Boolean(false));
			if (!(Boolean)lock.get("coil_power")){
				lock.put("coil_power", true);
				checkUnlock();
					String val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"coil_power");
					if (val == null) val = http.Property.getValueOfProperty(this.getName().replace(" ", "%20"),"Coil_power");
					coil_power= val;
			}
		return coil_power;
	}
	...
	public String getQueue() {
		// Generated by python script located in this directory
			if (!lock.containsKey("queue")) lock.put("queue", new Boolean(false));
			if (!(Boolean)lock.get("queue")){
				lock.put("queue", true);
				checkUnlock();
	...
	public String getStall_voltage() {
		// Generated by python script located in this directory
			if (!lock.containsKey("stall_voltage")) lock.put("stall_voltage", new Boolean(false));
			if (!(Boolean)lock.get("stall_voltage")){
	...
	public String getStart_voltage() {
		// Generated by python script located in this directory
			if (!lock.containsKey("start_voltage")) lock.put("start_voltage", new Boolean(false));
			if (!(Boolean)lock.get("start_voltage")){
	...
	public String getStall_impedance() {
		// Generated by python script located in this directory
			if (!lock.containsKey("stall_impedance")) lock.put("stall_impedance", new Boolean(false));
			if (!(Boolean)lock.get("stall_impedance")){
	...
	public String getTrip_delay() {
		// Generated by python script located in this directory
			if (!lock.containsKey("trip_delay")) lock.put("trip_delay", new Boolean(false));
			if (!(Boolean)lock.get("trip_delay")){
	...
	public String getReset_delay() {
		// Generated by python script located in this directory
			if (!lock.containsKey("reset_delay")) lock.put("reset_delay", new Boolean(false));
			if (!(Boolean)lock.get("reset_delay")){
