 ...
 * @generated
 */
public class DryerImpl extends ConnectionImpl implements Dryer {
		boolean lock = false;
	/**
	...
	public String getCoil_power() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"coil_power");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Coil_power");
				coil_power= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
