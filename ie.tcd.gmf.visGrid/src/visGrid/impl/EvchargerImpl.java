...
public class EvchargerImpl extends ConnectionImpl implements Evcharger {
	...
	public String getCharger_type() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"charger_type");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Charger_type");
				charger_type= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getVehicle_type() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"vehicle_type");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Vehicle_type");
				vehicle_type= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getP_go_home() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"p_go_home");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"P_go_home");
				p_go_home= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getP_go_work() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"p_go_work");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"P_go_work");
				p_go_work= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getWork_dist() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"work_dist");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Work_dist");
				work_dist= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getCapacity() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"capacity");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Capacity");
				capacity= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getCharge() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"charge");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Charge");
				charge= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getCharge_at_work() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"charge_at_work");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Charge_at_work");
				charge_at_work= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getCharge_throttle() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"charge_throttle");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Charge_throttle");
				charge_throttle= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public String getDemand_profile() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"demand_profile");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Demand_profile");
				demand_profile= val;
			} catch (Exception e) {
				e.printStackTrace();
			}
