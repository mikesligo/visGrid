 ...
 * <ul>
 *   <li>{@link visGrid.impl.MotorImpl#getConnection <em>Connection</em>}</li>
...
public class MotorImpl extends EObjectImpl implements Motor {
	...
	public EList<Connections> getConnection() {
		if (connection == null) {
			connection = new EObjectResolvingEList<Connections>(Connections.class, this, VisGridPackage.MOTOR__CONNECTION);
		}
		return connection;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisGridPackage.MOTOR__CONNECTION:
