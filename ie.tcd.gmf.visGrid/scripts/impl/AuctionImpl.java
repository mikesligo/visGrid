...
public class AuctionImpl extends ConnectionImpl implements Auction {
	...
	public String getLast__Q() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"last__Q");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"last__Q");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"last%20Q");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Last%20Q");
				last__Q= val;
			} catch (Exception e) {
				this.setLast__Q("unknown");
				e.printStackTrace();
			}
		}
		// Generated by python script located in this directory
	...
	public String getLast__P() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"last__P");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"last__P");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"last%20P");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Last%20P");
				last__P= val;
			} catch (Exception e) {
				this.setLast__P("unknown");
				e.printStackTrace();
			}
		}
		// Generated by python script located in this directory
	...
	public String getNext__Q() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"next__Q");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"next__Q");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"next%20Q");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Next%20Q");
				next__Q= val;
			} catch (Exception e) {
				this.setNext__Q("unknown");
				e.printStackTrace();
			}
		}
		// Generated by python script located in this directory
	...
	public String getNext__P() {
		...
		if (!lock){
			try {
				String val = http.Property.getValueOfProperty(this.getName(),"next__P");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"next__P");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"next%20P");
				if (val == null) val = http.Property.getValueOfProperty(this.getName(),"Next%20P");
				next__P= val;
			} catch (Exception e) {
				this.setNext__P("unknown");
				e.printStackTrace();
			}
		}
		// Generated by python script located in this directory
