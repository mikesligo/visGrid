 ...
 * @generated
 */
public class ThreeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ThreeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new testLink.diagram.edit.policies.ThreeItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(testLink.diagram.providers.TestLinkElementTypes.LinkEReference0_4001);
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == testLink.diagram.providers.TestLinkElementTypes.LinkEReference0_4001) {
